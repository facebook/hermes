...
TEST(BCP47Parser, LanguageIdTest) {
  ...
  ParsedLocaleIdentifier &locale1 = *parserOpt;
  ...
  ParsedLocaleIdentifier &locale2 = *parserOpt;
  ...
  ParsedLocaleIdentifier &locale3 = *parserOpt;
  ...
  ParsedLocaleIdentifier &locale4 = *parserOpt;
  ...
  ParsedLocaleIdentifier &locale5 = *parserOpt;
...
TEST(BCP47Parser, ExtensionText) {
  ...
  EXPECT_TRUE(keywordsIt->second.empty());
  keywordsIt++;
