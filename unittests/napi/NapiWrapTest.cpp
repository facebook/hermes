...
TEST_F(NapiTestFixture, Wrap_ResultRequiresFinalizer) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_wrap(env_, obj, nullptr, nullptr, nullptr, &ref));
...
TEST_F(NapiTestFixture, WrapUnwrap_Basic) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_wrap(env_, obj, &nativeData, nullptr, nullptr, nullptr));
...
TEST_F(NapiTestFixture, WrapUnwrap_NullNativeData) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_wrap(env_, obj, nullptr, nullptr, nullptr, nullptr));
...
TEST_F(NapiTestFixture, Wrap_DoubleWrapError) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_wrap(env_, obj, &data1, nullptr, nullptr, nullptr));
...
TEST_F(NapiTestFixture, Unwrap_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_unwrap(nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, Unwrap_NotAnObject) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, "hello", 5, &str));

  void *data = nullptr;
  EXPECT_EQ(
      napi_invalid_arg,
      napi_unwrap(env_, str, &data));
...
TEST_F(NapiTestFixture, RemoveWrap_NotWrapped) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_remove_wrap(env_, obj, &data));
...
TEST_F(NapiTestFixture, RemoveWrap_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_remove_wrap(nullptr, nullptr, nullptr));
}

TEST_F(NapiTestFixture, RemoveWrap_NullJsObject) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_remove_wrap(env_, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, RemoveWrap_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_remove_wrap(env_, num, &data));
