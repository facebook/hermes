...
TEST_F(NapiTestFixture, CreateStringUtf8_SimpleASCII) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "hello", 5, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf8_AutoLength) {
  ...
  ASSERT_EQ(
      ...
      napi_create_string_utf8(
          env_, "world", NAPI_AUTO_LENGTH, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf8_MultibyteUTF8) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, utf8, utf8Len, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf8_TypeofIsString) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "test", 4, &result));
...
TEST_F(NapiTestFixture, CreateStringUtf8_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_string_utf8(nullptr, "hello", 5, nullptr));
}

TEST_F(NapiTestFixture, CreateStringUtf8_NullResult) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_string_utf8(env_, "hello", 5, nullptr));
}
...
TEST_F(NapiTestFixture, CreateStringUtf8_NullStrWithZeroLength) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, nullptr, 0, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf8_NullStrWithNonZeroLength) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_string_utf8(env_, nullptr, 5, &result));
}
...
TEST_F(NapiTestFixture, CreateStringUtf8_InvalidContinuationByte) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, input, 2, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf8_TruncatedTwoByte) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, input, 1, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf8_StrayHighByte) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, input, 3, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_EmptyString) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, u"", 0, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_SimpleASCII) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, u"hello", 5, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_AutoLength) {
  ...
  ASSERT_EQ(
      ...
      napi_create_string_utf16(
          env_, u"world", NAPI_AUTO_LENGTH, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_SingleChar) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, u"A", 1, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_NonASCII) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf16(env_, u"caf\u00E9", 4, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_SurrogatePair) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, emoji, 2, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_BMP) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf16(env_, u"\u2603", 1, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_TypeofIsString) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, u"test", 4, &result));
...
TEST_F(NapiTestFixture, CreateStringUtf16_NullResult) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_string_utf16(env_, u"hello", 5, nullptr));
}
...
TEST_F(NapiTestFixture, CreateStringUtf16_NullStrWithZeroLength) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf16(env_, nullptr, 0, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringUtf16_NullStrWithNonZeroLength) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_string_utf16(env_, nullptr, 5, &result));
}
...
TEST_F(NapiTestFixture, CreateStringUtf16_MultipleStringsInScope) {
  ...
  napi_value s2 = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, u"foo", 3, &s1));
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, u"bar", 3, &s2));
...
TEST_F(NapiTestFixture, CreateStringUtf16_EmptyWithAutoLength) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf16(
          env_, u"", NAPI_AUTO_LENGTH, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_EmptyString) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_latin1(env_, "", 0, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_SimpleASCII) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, "hello", 5, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_SingleChar) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_latin1(env_, "A", 1, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_NonASCII) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, latin1, 4, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_HighByte) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, latin1, 1, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_AllHighBytes) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, latin1, 128, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_TypeofIsString) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, "test", 4, &result));
...
TEST_F(NapiTestFixture, CreateStringLatin1_NullResult) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_string_latin1(env_, "hello", 5, nullptr));
}
...
TEST_F(NapiTestFixture, CreateStringLatin1_NullStrWithZeroLength) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, nullptr, 0, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateStringLatin1_NullStrWithNonZeroLength) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_string_latin1(env_, nullptr, 5, &result));
}
...
TEST_F(NapiTestFixture, CreateStringLatin1_MultipleStringsInScope) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, "foo", 3, &s1));
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, "bar", 3, &s2));
...
TEST_F(NapiTestFixture, CreateStringLatin1_RoundtripWithUtf16Creation) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, latin1, 4, &latin1Result));
...
TEST_F(NapiTestFixture, GetValueStringUtf8_MultibyteUTF8) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, "caf\xC3\xA9", 5, &str));
...
TEST_F(NapiTestFixture, GetValueStringUtf8_ThreeByte) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, "\xE2\x98\x83", 3, &str));
...
TEST_F(NapiTestFixture, GetValueStringUtf8_TruncationASCII) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf8(env_, str, buf, 4, &written));
  EXPECT_EQ(3u, written);
...
TEST_F(NapiTestFixture, GetValueStringUtf8_TruncationUTF8) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf8(env_, str, buf, 5, &written));
...
TEST_F(NapiTestFixture, GetValueStringUtf8_BufsizeOne) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf8(env_, str, buf, 1, &written));
  EXPECT_EQ(0u, written);
  EXPECT_STREQ("", buf);
...
TEST_F(NapiTestFixture, GetValueStringUtf8_BufsizeZero) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf8(env_, str, buf, 0, &written));
  EXPECT_EQ(0u, written);
...
TEST_F(NapiTestFixture, GetValueStringUtf8_ExactFit) {
  ...
  napi_value str = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "abcd", 4, &str));
...
TEST_F(NapiTestFixture, GetValueStringUtf8_NullResult) {
  ...
  ASSERT_EQ(
      ...
      napi_get_value_string_utf8(
          env_, str, buf, sizeof(buf), nullptr));
  EXPECT_STREQ("hello", buf);
...
TEST_F(NapiTestFixture, GetValueStringUtf8_Undefined) {
  ...
  EXPECT_EQ(
      napi_string_expected,
      napi_get_value_string_utf8(
          env_, undef, buf, sizeof(buf), &written));
...
TEST_F(NapiTestFixture, GetValueStringUtf8_FromUTF16Creation) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf16(env_, u"caf\u00E9", 4, &str));
...
TEST_F(NapiTestFixture, GetValueStringUtf8_FromLatin1Creation) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, latin1, 4, &str));
...
TEST_F(NapiTestFixture, GetValueStringUtf16_SimpleASCII) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf16(env_, str, nullptr, 0, &len));
  EXPECT_EQ(5u, len);
...
TEST_F(NapiTestFixture, GetValueStringUtf16_EmptyString) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf16(env_, str, buf, 4, &written));
  EXPECT_EQ(0u, written);
  EXPECT_EQ(u'\0', buf[0]);
...
TEST_F(NapiTestFixture, GetValueStringUtf16_SurrogatePair) {
  ...
  napi_value str = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf16(env_, emoji, 2, &str));
...
TEST_F(NapiTestFixture, GetValueStringUtf16_BMP) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf16(env_, u"\u2603", 1, &str));
...
TEST_F(NapiTestFixture, GetValueStringUtf16_BufsizeOne) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf16(env_, str, buf, 1, &written));
  EXPECT_EQ(0u, written);
  EXPECT_EQ(u'\0', buf[0]);
...
TEST_F(NapiTestFixture, GetValueStringUtf16_BufsizeZero) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf16(env_, str, buf, 0, &written));
  EXPECT_EQ(0u, written);
  // Buffer should be untouched.
  EXPECT_EQ(u'x', buf[0]);
...
TEST_F(NapiTestFixture, GetValueStringUtf16_ExactFit) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf16(env_, str, buf, 5, &written));
  EXPECT_EQ(4u, written);
...
TEST_F(NapiTestFixture, GetValueStringUtf16_NullValue) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_value_string_utf16(
          env_, nullptr, nullptr, 0, nullptr));
}
...
TEST_F(NapiTestFixture, GetValueStringLatin1_SimpleASCII) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_latin1(env_, str, nullptr, 0, &len));
  EXPECT_EQ(5u, len);
  ...
  ASSERT_EQ(
      ...
      napi_get_value_string_latin1(
          env_, str, buf, sizeof(buf), &written));
  EXPECT_EQ(5u, written);
  EXPECT_STREQ("hello", buf);
...
TEST_F(NapiTestFixture, GetValueStringLatin1_HighBytesRoundtrip) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_latin1(env_, latin1, 128, &str));
...
TEST_F(NapiTestFixture, GetValueStringLatin1_TruncationASCII) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_latin1(env_, str, buf, 4, &written));
  EXPECT_EQ(3u, written);
  EXPECT_STREQ("hel", buf);
...
TEST_F(NapiTestFixture, GetValueStringLatin1_BufsizeOne) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_latin1(env_, str, buf, 1, &written));
  EXPECT_EQ(0u, written);
  EXPECT_STREQ("", buf);
...
TEST_F(NapiTestFixture, GetValueStringLatin1_ExactFit) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_latin1(env_, str, buf, 5, &written));
  EXPECT_EQ(4u, written);
  EXPECT_STREQ("abcd", buf);
...
TEST_F(NapiTestFixture, CreateExternalStringLatin1_Basic) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_latin1(
          env_, result, buf, sizeof(buf), &written));
  EXPECT_EQ(5u, written);
  EXPECT_STREQ("hello", buf);
...
TEST_F(NapiTestFixture, CreateExternalStringUtf16_AutoLength) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf16(
          env_, result, buf, 32, &written));
  EXPECT_EQ(11u, written);
  EXPECT_EQ(
      0, std::char_traits<char16_t>::compare(u"auto length", buf, 11));
...
TEST_F(NapiTestFixture, CreateExternalStringUtf16_NullCopied) {
  ...
  EXPECT_EQ(4u, written);
  EXPECT_EQ(
      0, std::char_traits<char16_t>::compare(u"test", buf, 4));
