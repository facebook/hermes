...
TEST_F(NapiCoercionTest, CoerceToBoolFromEmptyString) {
  ...
  napi_value str;
  ASSERT_EQ(
      napi_create_string_utf8(env_, "", NAPI_AUTO_LENGTH, &str),
      napi_ok);
...
TEST_F(NapiCoercionTest, CoerceToNumberFromUndefined) {
  ...
  napi_value result;
  ASSERT_EQ(
      napi_coerce_to_number(env_, undefined, &result), napi_ok);
...
TEST_F(NapiCoercionTest, CoerceToNumberFromTrue) {
  ...
  napi_value result;
  ASSERT_EQ(
      napi_coerce_to_number(env_, trueVal, &result), napi_ok);
...
TEST_F(NapiCoercionTest, CoerceToNumberFromFalse) {
  ...
  napi_value result;
  ASSERT_EQ(
      napi_coerce_to_number(env_, falseVal, &result), napi_ok);
...
TEST_F(NapiCoercionTest, CoerceToObjectFromUndefinedFails) {
  ...
  EXPECT_EQ(
      napi_coerce_to_object(env_, undefined, &result),
...
TEST_F(NapiCoercionTest, CoerceToObjectFromNullFails) {
  ...
  EXPECT_EQ(
      napi_coerce_to_object(env_, null, &result),
      napi_pending_exception);
...
TEST_F(NapiCoercionTest, CoerceToStringFromUndefined) {
  ...
  napi_value result;
  ASSERT_EQ(
      napi_coerce_to_string(env_, undefined, &result), napi_ok);
...
TEST_F(NapiCoercionTest, CoerceToStringFromTrue) {
  ...
  napi_value result;
  ASSERT_EQ(
      napi_coerce_to_string(env_, trueVal, &result), napi_ok);
...
TEST_F(NapiCoercionTest, CoerceToBoolNullEnv) {
  EXPECT_EQ(
      napi_coerce_to_bool(nullptr, nullptr, nullptr),
      napi_invalid_arg);
}
...
TEST_F(NapiCoercionTest, CoerceToBoolNullValue) {
  ...
  napi_value result;
  EXPECT_EQ(
      napi_coerce_to_bool(env_, nullptr, &result), napi_invalid_arg);
  closeScope();
}
...
TEST_F(NapiCoercionTest, CoerceToBoolNullResult) {
  ...
  ASSERT_EQ(napi_get_undefined(env_, &undefined), napi_ok);
  EXPECT_EQ(
      napi_coerce_to_bool(env_, undefined, nullptr), napi_invalid_arg);
  closeScope();
}
...
TEST_F(NapiCoercionTest, CoerceToNumberNullResult) {
  ...
  ASSERT_EQ(napi_get_undefined(env_, &undefined), napi_ok);
  EXPECT_EQ(
      napi_coerce_to_number(env_, undefined, nullptr),
      napi_invalid_arg);
  closeScope();
}
...
TEST_F(NapiCoercionTest, CoerceToObjectNullResult) {
  ...
  ASSERT_EQ(napi_get_undefined(env_, &undefined), napi_ok);
  EXPECT_EQ(
      napi_coerce_to_object(env_, undefined, nullptr),
      napi_invalid_arg);
  closeScope();
}
...
TEST_F(NapiCoercionTest, CoerceToStringNullResult) {
  ...
  ASSERT_EQ(napi_get_undefined(env_, &undefined), napi_ok);
  EXPECT_EQ(
      napi_coerce_to_string(env_, undefined, nullptr),
      napi_invalid_arg);
  closeScope();
}
...
TEST_F(NapiCoercionTest, CoerceToNumberWithPendingException) {
  ...
  ASSERT_EQ(napi_create_double(env_, 42.0, &num), napi_ok);
  EXPECT_EQ(
      napi_coerce_to_number(env_, num, &result),
      napi_pending_exception);
