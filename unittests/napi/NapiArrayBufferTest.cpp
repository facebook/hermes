...
TEST_F(NapiTestFixture, CreateArrayBuffer_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_arraybuffer(nullptr, 0, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, CreateArrayBuffer_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_arraybuffer(env_, 0, nullptr, nullptr));
...
TEST_F(NapiTestFixture, CreateArrayBuffer_ZeroLength) {
  ...
  size_t byteLen = 99;
  ASSERT_EQ(
      napi_ok, napi_get_arraybuffer_info(env_, ab, &infoData, &byteLen));
...
TEST_F(NapiTestFixture, CreateArrayBuffer_NullDataPtr) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 32, nullptr, &ab));
  ASSERT_NE(nullptr, ab);
...
TEST_F(NapiTestFixture, IsArrayBuffer_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_is_arraybuffer(nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, IsArrayBuffer_NullValue) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_is_arraybuffer(env_, nullptr, &result));
}
...
TEST_F(NapiTestFixture, IsArrayBuffer_NullResult) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 0, nullptr, &ab));
  EXPECT_EQ(
      napi_invalid_arg, napi_is_arraybuffer(env_, ab, nullptr));
...
TEST_F(NapiTestFixture, IsArrayBuffer_ArrayBufferIsTrue) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 16, nullptr, &ab));
...
TEST_F(NapiTestFixture, GetArrayBufferInfo_WrongType) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_arraybuffer_info(env_, obj, nullptr, nullptr));
...
TEST_F(NapiTestFixture, GetArrayBufferInfo_DataOnly) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 8, nullptr, &ab));

  void *data = nullptr;
  ASSERT_EQ(
      napi_ok, napi_get_arraybuffer_info(env_, ab, &data, nullptr));
...
TEST_F(NapiTestFixture, GetArrayBufferInfo_LengthOnly) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 64, nullptr, &ab));

  size_t byteLen = 0;
  ASSERT_EQ(
      napi_ok,
      napi_get_arraybuffer_info(env_, ab, nullptr, &byteLen));
...
TEST_F(NapiTestFixture, GetArrayBufferInfo_BothNull) {
  ...
  EXPECT_EQ(
      napi_ok,
      napi_get_arraybuffer_info(env_, ab, nullptr, nullptr));
