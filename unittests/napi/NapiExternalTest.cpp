...
TEST_F(NapiTestFixture, GetValueExternal_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_value_external(nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, GetValueExternal_NullValue) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_value_external(env_, nullptr, &data));
}
...
TEST_F(NapiTestFixture, GetValueExternal_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_value_external(env_, ext, nullptr));
...
TEST_F(NapiTestFixture, GetValueExternal_WrongType_Object) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_value_external(env_, obj, &data));
...
TEST_F(NapiTestFixture, GetValueExternal_WrongType_Number) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_value_external(env_, num, &data));
