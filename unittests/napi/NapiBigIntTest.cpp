...
TEST_F(NapiTestFixture, CreateBigIntInt64_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg, napi_create_bigint_int64(nullptr, 0, nullptr));
}

TEST_F(NapiTestFixture, CreateBigIntInt64_NullResult) {
  EXPECT_EQ(
      napi_invalid_arg, napi_create_bigint_int64(env_, 0, nullptr));
}
...
TEST_F(NapiTestFixture, CreateBigIntUint64_Zero) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_bigint_uint64(env_, result, &val, &lossless));
  EXPECT_EQ(0u, val);
  EXPECT_TRUE(lossless);
...
TEST_F(NapiTestFixture, CreateBigIntUint64_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg, napi_create_bigint_uint64(nullptr, 0, nullptr));
}

TEST_F(NapiTestFixture, CreateBigIntUint64_NullResult) {
  EXPECT_EQ(
      napi_invalid_arg, napi_create_bigint_uint64(env_, 0, nullptr));
}
...
TEST_F(NapiTestFixture, CreateBigIntWords_ZeroWords) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 0, 0, words, &result));
...
TEST_F(NapiTestFixture, CreateBigIntWords_SingleWordPositive) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 0, 1, words, &result));
...
TEST_F(NapiTestFixture, CreateBigIntWords_SingleWordNegative) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 1, 1, words, &result));
...
TEST_F(NapiTestFixture, CreateBigIntWords_TwoWordsPositive) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 0, 2, words, &result));
...
TEST_F(NapiTestFixture, CreateBigIntWords_NullWords) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_bigint_words(env_, 0, 1, nullptr, &result));
}
...
TEST_F(NapiTestFixture, CreateBigIntWords_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_bigint_words(env_, 0, 1, words, nullptr));
}
...
TEST_F(NapiTestFixture, GetBigIntInt64_LossyFromLargePositive) {
  ...
  uint64_t maxVal = static_cast<uint64_t>(
  ...
  bool lossless = true;
  ASSERT_EQ(
      napi_ok, napi_get_value_bigint_int64(env_, bi, &val, &lossless));
...
TEST_F(NapiTestFixture, GetBigIntInt64_LossyFromNegative) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 1, 2, words, &bi));
...
TEST_F(NapiTestFixture, GetBigIntInt64_NullLossless) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_value_bigint_int64(env_, bi, &val, nullptr));
...
TEST_F(NapiTestFixture, GetBigIntUint64_LossyFromNegative) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_bigint_uint64(env_, bi, &val, &lossless));
  EXPECT_FALSE(lossless);
...
TEST_F(NapiTestFixture, GetBigIntUint64_LossyFromTooLarge) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 0, 2, words, &bi));
...
TEST_F(NapiTestFixture, GetBigIntUint64_TypeErrorOnString) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, "hello", NAPI_AUTO_LENGTH, &str));
...
TEST_F(NapiTestFixture, GetBigIntWords_RoundtripViaWords) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 0, 2, inWords, &bi));
...
TEST_F(NapiTestFixture, GetBigIntWords_NegativeRoundtripViaWords) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_bigint_words(env_, 1, 2, inWords, &bi));
...
TEST_F(NapiTestFixture, GetBigIntWords_TypeErrorOnNumber) {
  ...
  EXPECT_EQ(
      napi_bigint_expected,
      napi_get_value_bigint_words(
          env_, num, nullptr, &word_count, nullptr));
