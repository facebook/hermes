...
TEST_F(NapiTestFixture, IsTypedArray_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_is_typedarray(nullptr, nullptr, nullptr));
}

TEST_F(NapiTestFixture, IsTypedArray_NullValue) {
  bool result = false;
  EXPECT_EQ(
      napi_invalid_arg, napi_is_typedarray(env_, nullptr, &result));
}
...
TEST_F(NapiTestFixture, IsTypedArray_NullResult) {
  ...
  ASSERT_EQ(
      ...
      napi_create_typedarray(
          env_, napi_uint8_array, 16, ab, 0, &ta));
...
TEST_F(NapiTestFixture, CreateTypedArray_NullArrayBuffer) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_typedarray(
          env_, napi_uint8_array, 0, nullptr, 0, &result));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateTypedArray_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_typedarray(
          env_, napi_uint8_array, 16, ab, 0, nullptr));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateTypedArray_NotArrayBuffer) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_typedarray(
          env_, napi_uint8_array, 0, obj, 0, &result));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateTypedArray_MisalignedOffset) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_typedarray(
          env_, napi_int32_array, 1, ab, 1, &result));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateTypedArray_OutOfBounds) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_typedarray(
          env_, napi_int32_array, 5, ab, 0, &result));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateTypedArray_OffsetPlusLengthOutOfBounds) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_typedarray(
          env_, napi_int32_array, 3, ab, 8, &result));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateTypedArray_AllTypes) {
  ...
  for (const auto &info : kTypedArrayTypes) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_create_typedarray(
            env_, info.type, numElems, ab, 0, &ta))
...
TEST_F(NapiTestFixture, GetTypedArrayInfo_NullValue) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_typedarray_info(
          env_, nullptr, nullptr, nullptr, nullptr, nullptr,
          nullptr));
}
...
TEST_F(NapiTestFixture, GetTypedArrayInfo_AllOutputParams) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 32, &abData, &ab));
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_int32_array, 4, ab, 8, &ta));
...
TEST_F(NapiTestFixture, GetTypedArrayInfo_TypeForEachKind) {
  ...
  for (const auto &info : kTypedArrayTypes) {
    ...
    ASSERT_EQ(
        napi_ok,
        napi_get_typedarray_info(
            env_, ta, &gotType, &gotLength, nullptr, nullptr,
            nullptr))
        << info.name;
...
TEST_F(NapiTestFixture, CreateTypedArray_WriteReadUint8) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 8, &abData, &ab));

  napi_value ta = nullptr;
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_uint8_array, 8, ab, 0, &ta));
...
TEST_F(NapiTestFixture, CreateTypedArray_WriteReadInt32) {
  ...
  napi_value ab = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_arraybuffer(env_, 16, &abData, &ab));

  napi_value ta = nullptr;
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_int32_array, 4, ab, 0, &ta));
...
TEST_F(NapiTestFixture, CreateTypedArray_WriteReadFloat64) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_float64_array, 2, ab, 0, &ta));
...
TEST_F(NapiTestFixture, CreateTypedArray_WithByteOffset) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_int32_array, 2, ab, 12, &ta));
...
TEST_F(NapiTestFixture, CreateTypedArray_ZeroLength) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_uint8_array, 0, ab, 0, &ta));
...
TEST_F(NapiTestFixture, CreateTypedArray_SharedArrayBuffer) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_uint8_array, 8, ab, 0, &ta1));

  napi_value ta2 = nullptr;
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(
          env_, napi_uint8_array, 8, ab, 8, &ta2));
