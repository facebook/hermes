...
static napi_value createArrayBuffer(
    napi_env env,
    size_t byteLen,
    void **data = nullptr) {
...
TEST_F(NapiTestFixture, IsDataView_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_is_dataview(nullptr, nullptr, nullptr));
}

TEST_F(NapiTestFixture, IsDataView_NullValue) {
  bool result = false;
  EXPECT_EQ(
      napi_invalid_arg, napi_is_dataview(env_, nullptr, &result));
}
...
TEST_F(NapiTestFixture, IsDataView_NullResult) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_dataview(env_, 16, ab, 0, &dv));
...
TEST_F(NapiTestFixture, IsDataView_TypedArrayIsFalse) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_typedarray(env_, napi_uint8_array, 16, ab, 0, &ta));
...
TEST_F(NapiTestFixture, CreateDataView_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_dataview(nullptr, 0, nullptr, 0, nullptr));
}
...
TEST_F(NapiTestFixture, CreateDataView_NullArrayBuffer) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_dataview(env_, 0, nullptr, 0, &result));
}
...
TEST_F(NapiTestFixture, CreateDataView_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_dataview(env_, 16, ab, 0, nullptr));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateDataView_NotArrayBuffer) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_dataview(env_, 0, obj, 0, &dv));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateDataView_OutOfBounds) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_dataview(env_, 17, ab, 0, &dv));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, CreateDataView_OffsetPlusLengthOutOfBounds) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_dataview(env_, 8, ab, 10, &dv));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, GetDataViewInfo_NullDataView) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_dataview_info(
          env_, nullptr, &len, nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, GetDataViewInfo_NotDataView) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_dataview_info(
          env_, obj, &len, nullptr, nullptr, nullptr));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, GetDataViewInfo_ByteLength) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_dataview_info(
          env_, dv, &byteLength, nullptr, nullptr, nullptr));
...
TEST_F(NapiTestFixture, GetDataViewInfo_ByteOffset) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_dataview_info(
          env_, dv, nullptr, nullptr, nullptr, &byteOffset));
...
TEST_F(NapiTestFixture, GetDataViewInfo_DataPointer) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_dataview_info(
          env_, dv, nullptr, &dvData, nullptr, nullptr));
...
TEST_F(NapiTestFixture, GetDataViewInfo_ArrayBuffer) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_dataview_info(
          env_, dv, nullptr, nullptr, &dvAb, nullptr));
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_arraybuffer_info(env_, ab, &abData, &abLen));
  void *dvAbData = nullptr;
  size_t dvAbLen = 0;
  ASSERT_EQ(
      napi_ok,
      napi_get_arraybuffer_info(env_, dvAb, &dvAbData, &dvAbLen));
...
TEST_F(NapiTestFixture, GetDataViewInfo_AllOutputs) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_dataview_info(
          env_, dv, &byteLength, &data, &dvAb, &byteOffset));
...
TEST_F(NapiTestFixture, GetDataViewInfo_AllNull) {
  ...
  EXPECT_EQ(
      napi_ok,
      napi_get_dataview_info(
          env_, dv, nullptr, nullptr, nullptr, nullptr));
  closeScope(env_, scope);
}
