...
TEST_F(NapiTestFixture, SetGetProperty_NumericKey) {
  ...
  size_t len = 0;
  ASSERT_EQ(
      napi_ok, napi_get_value_string_utf8(env_, result, buf, 16, &len));
  EXPECT_EQ(4u, len);
...
TEST_F(NapiTestFixture, GetProperty_NonExistent) {
  ...
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "missing", 7, &key));
...
TEST_F(NapiTestFixture, SetProperty_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_set_property(nullptr, nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, SetProperty_NullKey) {
  ...
  EXPECT_EQ(
      napi_invalid_arg, napi_set_property(env_, obj, nullptr, val));
...
TEST_F(NapiTestFixture, SetProperty_NullValue) {
  ...
  EXPECT_EQ(
      napi_invalid_arg, napi_set_property(env_, obj, key, nullptr));
...
TEST_F(NapiTestFixture, SetProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected, napi_set_property(env_, num, key, val));
...
TEST_F(NapiTestFixture, GetProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      ...
      napi_get_property(env_, num, key, &result));
...
TEST_F(NapiTestFixture, SetProperty_NullObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_set_property(env_, nullptr, key, val));
...
TEST_F(NapiTestFixture, HasProperty_Exists) {
  ...
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "present", 7, &key));
  napi_value val = nullptr;
  ASSERT_EQ(napi_ok, napi_create_int32(env_, 1, &val));
  ASSERT_EQ(napi_ok, napi_set_property(env_, obj, key, val));
...
TEST_F(NapiTestFixture, HasProperty_NotExists) {
  ...
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "absent", 6, &key));
...
TEST_F(NapiTestFixture, HasProperty_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_property(nullptr, nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, HasProperty_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_property(env_, obj, key, nullptr));
...
TEST_F(NapiTestFixture, HasProperty_NullKey) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_property(env_, obj, nullptr, &hasIt));
...
TEST_F(NapiTestFixture, HasProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_has_property(env_, num, key, &hasIt));
...
TEST_F(NapiTestFixture, DeleteProperty_Basic) {
  ...
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "toDelete", 8, &key));
  napi_value val = nullptr;
  ASSERT_EQ(napi_ok, napi_create_int32(env_, 1, &val));
  ASSERT_EQ(napi_ok, napi_set_property(env_, obj, key, val));
  ...
  bool deleted = false;
  ASSERT_EQ(
      napi_ok, napi_delete_property(env_, obj, key, &deleted));
  EXPECT_TRUE(deleted);
...
TEST_F(NapiTestFixture, DeleteProperty_NonExistent) {
  ...
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "noSuch", 6, &key));
...
TEST_F(NapiTestFixture, DeleteProperty_NullResult) {
  ...
  ASSERT_EQ(
      napi_ok, napi_delete_property(env_, obj, key, nullptr));
...
TEST_F(NapiTestFixture, DeleteProperty_NullKey) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_delete_property(env_, obj, nullptr, &deleted));
...
TEST_F(NapiTestFixture, DeleteProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_delete_property(env_, str, key, &deleted));
...
TEST_F(NapiTestFixture, SetGetNamedProperty_Basic) {
  ...
  ASSERT_EQ(napi_ok, napi_create_int32(env_, 42, &val));
  ASSERT_EQ(
      napi_ok, napi_set_named_property(env_, obj, "answer", val));

  // Get it back.
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "answer", &result));
...
TEST_F(NapiTestFixture, HasNamedProperty_Exists) {
  ...
  ASSERT_EQ(napi_ok, napi_create_int32(env_, 1, &val));
  ASSERT_EQ(
      napi_ok, napi_set_named_property(env_, obj, "present", val));

  bool hasIt = false;
  ASSERT_EQ(
      napi_ok,
      napi_has_named_property(env_, obj, "present", &hasIt));
  EXPECT_TRUE(hasIt);
...
TEST_F(NapiTestFixture, HasNamedProperty_NotExists) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_has_named_property(env_, obj, "absent", &hasIt));
  EXPECT_FALSE(hasIt);
...
TEST_F(NapiTestFixture, SetNamedProperty_Overwrite) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_get_named_property(env_, obj, "x", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(20.0, d);
...
TEST_F(NapiTestFixture, GetNamedProperty_NonExistent) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "missing", &result));
...
TEST_F(NapiTestFixture, HasNamedProperty_NullEnv) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_named_property(nullptr, nullptr, "k", &hasIt));
}
...
TEST_F(NapiTestFixture, SetNamedProperty_NullName) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_set_named_property(env_, obj, nullptr, val));
...
TEST_F(NapiTestFixture, GetNamedProperty_NullName) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_named_property(env_, obj, nullptr, &result));
...
TEST_F(NapiTestFixture, HasNamedProperty_NullName) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_named_property(env_, obj, nullptr, &hasIt));
...
TEST_F(NapiTestFixture, SetNamedProperty_NullValue) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_set_named_property(env_, obj, "k", nullptr));
...
TEST_F(NapiTestFixture, GetNamedProperty_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_named_property(env_, obj, "k", nullptr));
...
TEST_F(NapiTestFixture, HasNamedProperty_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_named_property(env_, obj, "k", nullptr));
...
TEST_F(NapiTestFixture, SetNamedProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_set_named_property(env_, num, "k", val));
...
TEST_F(NapiTestFixture, GetNamedProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_get_named_property(env_, num, "k", &result));
...
TEST_F(NapiTestFixture, HasNamedProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_has_named_property(env_, num, "k", &hasIt));
...
TEST_F(NapiTestFixture, SetNamedProperty_PendingException) {
  ...
  EXPECT_EQ(
      napi_pending_exception,
      napi_set_named_property(env_, obj, "k", val));
...
TEST_F(NapiTestFixture, NamedProperty_InteropWithValueKey) {
  ...
  ASSERT_EQ(
      napi_ok, napi_set_named_property(env_, obj, "shared", val));

  // Read via value-key API.
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, "shared", 6, &key));
  napi_value result = nullptr;
  ASSERT_EQ(napi_ok, napi_get_property(env_, obj, key, &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "shared", &result2));
...
TEST_F(NapiTestFixture, NamedProperty_IndexLikeName) {
  ...
  bool hasIt = false;
  ASSERT_EQ(
      napi_ok, napi_has_named_property(env_, obj, "0", &hasIt));
  EXPECT_TRUE(hasIt);

  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_get_named_property(env_, obj, "0", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(99.0, d);
...
TEST_F(NapiTestFixture, NamedProperty_EmptyName) {
  ...
  bool hasIt = false;
  ASSERT_EQ(
      napi_ok, napi_has_named_property(env_, obj, "", &hasIt));
  EXPECT_TRUE(hasIt);

  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_get_named_property(env_, obj, "", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(7.0, d);
...
TEST_F(NapiTestFixture, SetGetProperty_MultipleKeys) {
  ...
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "hello", 5, &valB));
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf8(env_, resultB, buf, 16, &len));
...
TEST_F(NapiTestFixture, SetProperty_ValueIsObject) {
  ...
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "nested", 6, &key));
...
TEST_F(NapiTestFixture, SetElement_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_set_element(nullptr, nullptr, 0, nullptr));
}
...
TEST_F(NapiTestFixture, GetElement_NullEnv) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_element(nullptr, nullptr, 0, &result));
}
...
TEST_F(NapiTestFixture, HasElement_NullEnv) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_element(nullptr, nullptr, 0, &hasIt));
}
...
TEST_F(NapiTestFixture, DeleteElement_NullEnv) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_delete_element(nullptr, nullptr, 0, &deleted));
}
...
TEST_F(NapiTestFixture, SetElement_NullValue) {
  ...
  EXPECT_EQ(
      napi_invalid_arg, napi_set_element(env_, obj, 0, nullptr));
...
TEST_F(NapiTestFixture, GetElement_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg, napi_get_element(env_, obj, 0, nullptr));
...
TEST_F(NapiTestFixture, HasElement_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg, napi_has_element(env_, obj, 0, nullptr));
...
TEST_F(NapiTestFixture, SetElement_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected, napi_set_element(env_, num, 0, val));
...
TEST_F(NapiTestFixture, GetElement_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_get_element(env_, num, 0, &result));
...
TEST_F(NapiTestFixture, HasElement_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_has_element(env_, num, 0, &hasIt));
...
TEST_F(NapiTestFixture, DeleteElement_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_delete_element(env_, str, 0, &deleted));
...
TEST_F(NapiTestFixture, SetElement_NullObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_set_element(env_, nullptr, 0, val));
...
TEST_F(NapiTestFixture, SetElement_PendingException) {
  ...
  EXPECT_EQ(
      napi_pending_exception,
      napi_set_element(env_, obj, 0, val));
...
TEST_F(NapiTestFixture, Element_LargeIndex) {
  ...
  ASSERT_EQ(
      napi_ok, napi_set_element(env_, obj, UINT32_MAX, val));

  bool hasIt = false;
  ASSERT_EQ(
      napi_ok, napi_has_element(env_, obj, UINT32_MAX, &hasIt));
  EXPECT_TRUE(hasIt);

  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_get_element(env_, obj, UINT32_MAX, &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(77.0, d);
...
TEST_F(NapiTestFixture, Element_InteropWithNamedProperty) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "2", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(88.0, d);
...
TEST_F(NapiTestFixture, Element_SetDifferentValueTypes) {
  ...
  napi_value str = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "hi", 2, &str));
...
TEST_F(NapiTestFixture, CreateArrayWithLength_Basic) {
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_array_with_length(env_, 10, &result));
  ASSERT_NE(nullptr, result);
...
TEST_F(NapiTestFixture, CreateArrayWithLength_NullEnv) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_array_with_length(nullptr, 5, &result));
}
...
TEST_F(NapiTestFixture, CreateArrayWithLength_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_create_array_with_length(env_, 5, nullptr));
  closeScope(env_, scope);
}
...
TEST_F(NapiTestFixture, IsArray_String) {
  ...
  napi_value str = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "hello", 5, &str));
...
TEST_F(NapiTestFixture, IsArray_NullEnv) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_is_array(nullptr, nullptr, &isArray));
}
...
TEST_F(NapiTestFixture, IsArray_NullValue) {
  ...
  bool isArray = false;
  EXPECT_EQ(
      napi_invalid_arg, napi_is_array(env_, nullptr, &isArray));
...
TEST_F(NapiTestFixture, GetArrayLength_PreAllocated) {
  ...
  napi_value arr = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_array_with_length(env_, 100, &arr));
...
TEST_F(NapiTestFixture, GetArrayLength_Number) {
  ...
  EXPECT_EQ(
      napi_array_expected,
      napi_get_array_length(env_, num, &length));
...
TEST_F(NapiTestFixture, GetArrayLength_NullEnv) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_array_length(nullptr, nullptr, &length));
}
...
TEST_F(NapiTestFixture, GetArrayLength_NullValue) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_array_length(env_, nullptr, &length));
...
TEST_F(NapiTestFixture, GetArrayLength_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_array_length(env_, arr, nullptr));
...
TEST_F(NapiTestFixture, GetArrayLength_PendingException) {
  ...
  EXPECT_EQ(
      napi_pending_exception,
      napi_get_array_length(env_, arr, &length));
...
TEST_F(NapiTestFixture, GetPropertyNames_NumericKeysAsStrings) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf8(env_, elem0, buf, sizeof(buf), &len));
  EXPECT_STREQ("0", buf);
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_value_string_utf8(env_, elem1, buf, sizeof(buf), &len));
  EXPECT_STREQ("1", buf);
...
TEST_F(NapiTestFixture, GetPropertyNames_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_property_names(nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, GetPropertyNames_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_property_names(env_, obj, nullptr));
...
TEST_F(NapiTestFixture, GetPropertyNames_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_get_property_names(env_, num, &names));
...
TEST_F(NapiTestFixture, GetPropertyNames_PendingException) {
  ...
  EXPECT_EQ(
      napi_pending_exception,
      napi_get_property_names(env_, obj, &names));
...
TEST_F(NapiTestFixture, HasOwnProperty_Exists) {
  ...
  ASSERT_EQ(napi_ok, napi_create_int32(env_, 1, &val));
  ASSERT_EQ(
      napi_ok, napi_set_named_property(env_, obj, "own", val));

  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "own", 3, &key));

  bool hasOwn = false;
  ASSERT_EQ(
      napi_ok, napi_has_own_property(env_, obj, key, &hasOwn));
  EXPECT_TRUE(hasOwn);
...
TEST_F(NapiTestFixture, HasOwnProperty_InheritedNotOwn) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, "toString", 8, &key));

  // napi_has_property should find it (searches prototype chain).
  bool hasProp = false;
  ASSERT_EQ(
      napi_ok, napi_has_property(env_, obj, key, &hasProp));
  EXPECT_TRUE(hasProp);
...
TEST_F(NapiTestFixture, HasOwnProperty_NumericKeyNotAllowed) {
  ...
  EXPECT_EQ(
      napi_name_expected,
      napi_has_own_property(env_, obj, numKey, &hasOwn));
...
TEST_F(NapiTestFixture, HasOwnProperty_NullKey) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_own_property(env_, obj, nullptr, &hasOwn));
...
TEST_F(NapiTestFixture, HasOwnProperty_NullResult) {
  ...
  napi_value key = nullptr;
  ASSERT_EQ(
      napi_ok, napi_create_string_utf8(env_, "k", 1, &key));

  EXPECT_EQ(
      napi_invalid_arg,
      napi_has_own_property(env_, obj, key, nullptr));
...
TEST_F(NapiTestFixture, HasOwnProperty_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_has_own_property(env_, num, key, &hasOwn));
...
TEST_F(NapiTestFixture, HasOwnProperty_PendingException) {
  ...
  EXPECT_EQ(
      napi_pending_exception,
      napi_has_own_property(env_, obj, key, &hasOwn));
...
TEST_F(NapiTestFixture, GetPrototype_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_prototype(nullptr, nullptr, nullptr));
}
...
TEST_F(NapiTestFixture, GetPrototype_NullResult) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_get_prototype(env_, obj, nullptr));
...
TEST_F(NapiTestFixture, GetPrototype_NotAnObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_get_prototype(env_, num, &proto));
...
TEST_F(NapiTestFixture, GetPrototype_PendingException) {
  ...
  EXPECT_EQ(
      napi_pending_exception,
      napi_get_prototype(env_, obj, &proto));
...
TEST_F(NapiTestFixture, GetPrototype_PrototypeHasProperties) {
  ...
  bool hasOwn = false;
  ASSERT_EQ(
      napi_ok, napi_has_own_property(env_, proto, key, &hasOwn));
  EXPECT_TRUE(hasOwn);
...
TEST_F(NapiTestFixture, DefineProperties_NullEnv) {
  EXPECT_EQ(
      napi_invalid_arg,
      napi_define_properties(nullptr, nullptr, 0, nullptr));
}
...
TEST_F(NapiTestFixture, DefineProperties_NotObject) {
  ...
  EXPECT_EQ(
      napi_object_expected,
      napi_define_properties(env_, num, 0, props));
...
TEST_F(NapiTestFixture, DefineProperties_NullProps) {
  ...
  EXPECT_EQ(
      napi_invalid_arg,
      napi_define_properties(env_, obj, 1, nullptr));
...
TEST_F(NapiTestFixture, DefineProperties_DataPropertyUtf8) {
  ...
  napi_property_descriptor props[] = {
      {"myProp", nullptr, nullptr, nullptr, nullptr, val,
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "myProp", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(42.0, d);
...
TEST_F(NapiTestFixture, DefineProperties_DataPropertyNameValue) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(env_, "foo", NAPI_AUTO_LENGTH, &key));

  napi_value val = nullptr;
  ASSERT_EQ(napi_ok, napi_create_double(env_, 99.0, &val));

  napi_property_descriptor props[] = {
      {nullptr, key, nullptr, nullptr, nullptr, val,
       napi_default_jsproperty, nullptr},
  };
  EXPECT_EQ(napi_ok, napi_define_properties(env_, obj, 1, props));
...
TEST_F(NapiTestFixture, DefineProperties_ReadOnly) {
  ...
  napi_property_descriptor props[] = {
      {"readOnly", nullptr, nullptr, nullptr, nullptr, val,
  ...
  ASSERT_EQ(
      napi_ok,
      napi_set_named_property(env_, obj, "readOnly", newVal));

  // Value should still be 10.
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "readOnly", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(10.0, d);
...
TEST_F(NapiTestFixture, DefineProperties_NotEnumerable) {
  ...
  napi_property_descriptor props[] = {
      {"hidden", nullptr, nullptr, nullptr, nullptr, val,
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "hidden", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(5.0, d);
  ...
  ASSERT_EQ(
      napi_ok, napi_get_property_names(env_, obj, &keys));
  uint32_t len = 0;
...
TEST_F(NapiTestFixture, DefineProperties_NotConfigurable) {
  ...
  napi_property_descriptor props[] = {
      {"locked", nullptr, nullptr, nullptr, nullptr, val,
       static_cast<napi_property_attributes>(
  ...
  ASSERT_EQ(
      ...
      napi_create_string_utf8(
          env_, "locked", NAPI_AUTO_LENGTH, &key));
  bool deleted = true;
  ASSERT_EQ(
      napi_ok, napi_delete_property(env_, obj, key, &deleted));
...
TEST_F(NapiTestFixture, DefineProperties_MethodUtf8) {
  ...
  napi_property_descriptor props[] = {
      {"myMethod", nullptr, methodCb, nullptr, nullptr, nullptr,
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "myMethod", &func));
  napi_valuetype type;
...
TEST_F(NapiTestFixture, DefineProperties_MethodWithData) {
  ...
  napi_property_descriptor props[] = {
      {"dataMethod", nullptr, methodCb, nullptr, nullptr, nullptr,
       napi_default_method, &userData},
  };
  EXPECT_EQ(napi_ok, napi_define_properties(env_, obj, 1, props));
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "dataMethod", &func));
  auto *phv = reinterpret_cast<PinnedHermesValue *>(func);
  auto funcHandle = Handle<Callable>::vmcast(phv);
  {
    GCScope gcScope(env_->runtime);
...
TEST_F(NapiTestFixture, DefineProperties_GetterOnly) {
  ...
  napi_property_descriptor props[] = {
      {"gProp", nullptr, nullptr, getter, nullptr, nullptr,
       static_cast<napi_property_attributes>(
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "gProp", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(42.0, d);
...
TEST_F(NapiTestFixture, DefineProperties_SetterOnly) {
  ...
  napi_property_descriptor props[] = {
      {"sProp", nullptr, nullptr, nullptr, setter, nullptr,
       static_cast<napi_property_attributes>(
           napi_enumerable | napi_configurable),
       &stored},
  };
  ...
  ASSERT_EQ(
      napi_ok,
      napi_set_named_property(env_, obj, "sProp", newVal));
...
TEST_F(NapiTestFixture, DefineProperties_GetterAndSetter) {
  ...
  napi_property_descriptor props[] = {
      {"gsProp", nullptr, nullptr, getter, setter, nullptr,
       static_cast<napi_property_attributes>(
           napi_enumerable | napi_configurable),
       &storage},
  };
  ...
  ASSERT_EQ(
      napi_ok,
      napi_get_named_property(env_, obj, "gsProp", &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(10.0, d);
  ...
  ASSERT_EQ(
      napi_ok,
      napi_set_named_property(env_, obj, "gsProp", newVal));
...
TEST_F(NapiTestFixture, DefineProperties_MultipleProps) {
  ...
  napi_property_descriptor props[] = {
      {"a", nullptr, nullptr, nullptr, nullptr, val1,
       napi_default_jsproperty, nullptr},
      {"b", nullptr, nullptr, nullptr, nullptr, val2,
       napi_default_jsproperty, nullptr},
      {"c", nullptr, methodCb, nullptr, nullptr, nullptr,
       napi_default_method, nullptr},
  };
  ...
  ASSERT_EQ(
      napi_ok, napi_get_named_property(env_, obj, "a", &result));
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(1.0, d);

  ASSERT_EQ(
      napi_ok, napi_get_named_property(env_, obj, "b", &result));
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(2.0, d);

  ASSERT_EQ(
      napi_ok, napi_get_named_property(env_, obj, "c", &result));
  napi_valuetype type;
  ASSERT_EQ(napi_ok, napi_typeof(env_, result, &type));
  EXPECT_EQ(napi_function, type);
...
TEST_F(NapiTestFixture, DefineProperties_SymbolKey) {
  ...
  napi_value symKey = nullptr;
  {
    ...
    auto sym = env_->runtime.getIdentifierTable()
                   .createNotUniquedSymbol(env_->runtime, strHandle);
    ASSERT_NE(ExecutionStatus::EXCEPTION, sym.getStatus());
    symKey = env_->addToCurrentScope(
        HermesValue::encodeSymbolValue(*sym));
  }
  ...
  napi_property_descriptor props[] = {
      {nullptr, symKey, nullptr, nullptr, nullptr, val,
       napi_default_jsproperty, nullptr},
  };
  EXPECT_EQ(napi_ok, napi_define_properties(env_, obj, 1, props));
  ...
  napi_value result = nullptr;
  ASSERT_EQ(
      napi_ok, napi_get_property(env_, obj, symKey, &result));
  double d = 0;
  ASSERT_EQ(napi_ok, napi_get_value_double(env_, result, &d));
  EXPECT_EQ(88.0, d);
...
TEST_F(NapiTestFixture, DefineProperties_InvalidNameKey) {
  ...
  napi_property_descriptor props[] = {
      {nullptr, numKey, nullptr, nullptr, nullptr, val,
       napi_default_jsproperty, nullptr},
  };
  EXPECT_EQ(
      napi_name_expected,
      napi_define_properties(env_, obj, 1, props));
...
TEST_F(NapiTestFixture, DefineProperties_PendingExceptionBlocks) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_string_utf8(
          env_, "test", NAPI_AUTO_LENGTH, &errMsg));
  ...
  EXPECT_EQ(
      napi_pending_exception,
      napi_define_properties(env_, obj, 0, nullptr));
...
TEST_F(NapiTestFixture, DefineProperties_AccessorNotEnumerable) {
  ...
  napi_property_descriptor props[] = {
      {"hidden", nullptr, nullptr, getter, nullptr, nullptr,
...
TEST_F(NapiTestFixture, GetAllPropertyNames_MixedStringAndSymbol) {
  ...
  for (uint32_t i = 0; i < length; ++i) {
    ...
    if (type == napi_string) {
      ...
      ASSERT_EQ(
          napi_ok,
          napi_get_value_string_utf8(env_, elem, nullptr, 0, &len));
      std::string str(len, '\0');
      ASSERT_EQ(
          napi_ok,
          napi_get_value_string_utf8(
              env_, elem, &str[0], len + 1, &len));
      EXPECT_EQ("foo", str);
...
TEST_F(NapiTestFixture, GetAllPropertyNames_SkipStrings_OnlySymbols) {
  ...
  ASSERT_EQ(
      napi_ok,
      napi_create_symbol(env_, nullptr, &sym));
  ASSERT_EQ(napi_ok, napi_create_int32(env_, 2, &val));
  ASSERT_EQ(napi_ok, napi_set_property(env_, obj, sym, val));
