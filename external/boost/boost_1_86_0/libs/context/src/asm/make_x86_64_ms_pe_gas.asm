...
.def	hoost_make_fcontext;	.scl	2;	.type	32;	.endef
.seh_proc	hoost_make_fcontext
hoost_make_fcontext:
.seh_endprologue
    ...
    /* will be entered after hoost_jump_fcontext() first time */
    movq  %rcx, 0x118(%rax)
...
finish:
    ...
    /* already reserved by hoost_make_fcontext() */
    /* exit code is zero */
    xorq  %rcx, %rcx
    /* exit application */
    call  _exit
