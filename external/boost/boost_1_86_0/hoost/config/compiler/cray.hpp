...
//
// `hoost/libs/config/doc/html/boost_config/boost_macro_reference.html`
//
...
// features, run 'b2' in 'hoost/libs/config/checks'. These are the macros
...
#include <hoost/config/compiler/common_edg.hpp>
...
// 'hoost/libs/config/include/hoost/config/detail/suffix.hpp' ensures that
