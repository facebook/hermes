...
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/stlport.hpp"
...
// Comeau STL:
#define BOOST_STDLIB_CONFIG "hoost/config/stdlib/libcomo.hpp"
...
// libc++
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/libcpp.hpp"

#elif defined(__GLIBCPP__) || defined(__GLIBCXX__)
// GNU libstdc++ 3
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/libstdcpp3.hpp"

#elif defined(__STL_CONFIG_H)
// generic SGI STL
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/sgi.hpp"

#elif defined(__MSL_CPP__)
// MSL standard lib:
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/msl.hpp"

#elif defined(__IBMCPP__) && defined(__COMPILER_VER__) && defined(__MVS__)
// IBM z/OS XL C/C++
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/xlcpp_zos.hpp"

#elif defined(__IBMCPP__)
// take the default VACPP std lib
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/vacpp.hpp"

#elif defined(MSIPL_COMPILE_H)
// Modena C++ standard library
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/modena.hpp"

#elif (defined(_YVALS) && !defined(__IBMCPP__)) || defined(_CPPLIB_VER)
// Dinkumware Library (this has to appear after any possible replacement libraries):
#  define BOOST_STDLIB_CONFIG "hoost/config/stdlib/dinkumware.hpp"
...
//
#  include "hoost/config/stdlib/stlport.hpp"
#  include "hoost/config/stdlib/libcomo.hpp"
#  include "hoost/config/stdlib/roguewave.hpp"
#  include "hoost/config/stdlib/libcpp.hpp"
#  include "hoost/config/stdlib/libstdcpp3.hpp"
#  include "hoost/config/stdlib/sgi.hpp"
#  include "hoost/config/stdlib/msl.hpp"
#  include "hoost/config/stdlib/xlcpp_zos.hpp"
#  include "hoost/config/stdlib/vacpp.hpp"
#  include "hoost/config/stdlib/modena.hpp"
#  include "hoost/config/stdlib/dinkumware.hpp"
#endif
