...
///
///    - PassInstrumentation wraps address of IRUnit into llvh::Any and passes
...
#include "llvh/ADT/Any.h"
#include "llvh/ADT/FunctionExtras.h"
#include "llvh/ADT/SmallVector.h"
#include "llvh/Support/TypeName.h"
#include <type_traits>
...
public:
  ...
  // as pointers, wrapped with llvh::Any
...
private:
  ...
  SmallVector<llvh::unique_function<BeforePassFunc>, 4> BeforePassCallbacks;
  SmallVector<llvh::unique_function<AfterPassFunc>, 4> AfterPassCallbacks;
  SmallVector<llvh::unique_function<BeforeAnalysisFunc>, 4>
      BeforeAnalysisCallbacks;
  SmallVector<llvh::unique_function<AfterAnalysisFunc>, 4>
...
public:
  ...
  bool runBeforePass(const PassT &Pass, const IRUnitT &IR) const {
    ...
    for (auto &C : Callbacks->BeforePassCallbacks)
      ShouldRun &= C(Pass.name(), llvh::Any(&IR));
    return ShouldRun;
  }
  ...
  bool invalidate(IRUnitT &, const class llvh::PreservedAnalyses &,
                  ExtraArgsT...) {
    return false;
  }
};
