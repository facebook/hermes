...
#include "llvh/Support/FormatCommon.h"
...
public:
  ...
  void format(llvh::raw_ostream &Stream, StringRef Style) {
...
public:
  ...
  void format(llvh::raw_ostream &Stream, StringRef Style) { Stream << Item; }
};
}
...
// llvh::Error values must be consumed before being destroyed.
