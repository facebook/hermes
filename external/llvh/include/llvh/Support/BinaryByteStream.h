...
#include "llvh/Support/BinaryStream.h"
#include "llvh/Support/BinaryStreamError.h"
#include "llvh/Support/Error.h"
#include "llvh/Support/FileOutputBuffer.h"
...
public:
  ...
  BinaryByteStream(ArrayRef<uint8_t> Data, llvh::support::endianness Endian)
      : Endian(Endian), Data(Data) {}
  BinaryByteStream(StringRef Data, llvh::support::endianness Endian)
      : Endian(Endian), Data(Data.bytes_begin(), Data.bytes_end()) {}

  llvh::support::endianness getEndian() const override { return Endian; }
...
protected:
  llvh::support::endianness Endian;
...
public:
  ...
  llvh::support::endianness getEndian() const override {
...
class AppendingBinaryByteStream : public WritableBinaryStream {
  ...
  llvh::support::endianness Endian = llvh::support::little;

public:
  AppendingBinaryByteStream() = default;
  AppendingBinaryByteStream(llvh::support::endianness Endian)
      : Endian(Endian) {}
