...
/** See llvh::createCoroEarlyPass function. */
void LLVMAddCoroEarlyPass(LLVMPassManagerRef PM);

/** See llvh::createCoroSplitPass function. */
void LLVMAddCoroSplitPass(LLVMPassManagerRef PM);

/** See llvh::createCoroElidePass function. */
void LLVMAddCoroElidePass(LLVMPassManagerRef PM);

/** See llvh::createCoroCleanupPass function. */
