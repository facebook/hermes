...
SetTheory::SetTheory() {
  addOperator("add", llvh::make_unique<AddOp>());
  addOperator("sub", llvh::make_unique<SubOp>());
  addOperator("and", llvh::make_unique<AndOp>());
  addOperator("shl", llvh::make_unique<ShlOp>());
  addOperator("trunc", llvh::make_unique<TruncOp>());
  addOperator("rotl", llvh::make_unique<RotOp>(false));
  addOperator("rotr", llvh::make_unique<RotOp>(true));
  addOperator("decimate", llvh::make_unique<DecimateOp>());
  addOperator("interleave", llvh::make_unique<InterleaveOp>());
  addOperator("sequence", llvh::make_unique<SequenceOp>());
}
...
void SetTheory::addFieldExpander(StringRef ClassName, StringRef FieldName) {
  addExpander(ClassName, llvh::make_unique<FieldExpander>(FieldName));
}
