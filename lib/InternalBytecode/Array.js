...
function arrayPrototypeReduceHelper(
  ...
  // Array.prototype.reduce and Array.prototype.reduceRight cannot be used as constructors
  if (new.target) throw _TypeError('This function cannot be used as a constructor.');
  ...
  if (len === 0 && !initialValuePresent) {
    throw _TypeError('Array.prototype.reduce() requires an intial value with empty array');
  }
...
Array.prototype.reduce = function reduce(callbackfn, initialValue = undefined) {
  return arrayPrototypeReduceHelper(this, callbackfn, initialValue, arguments.length >= 2, true);
}
 ...
 * @return an aggregated result after invoking callbackfn on all elements
 */
Array.prototype.reduceRight = function reduceRight(callbackfn, initialValue = undefined) {
  return arrayPrototypeReduceHelper(this, callbackfn, initialValue, arguments.length >= 2, false);
}
...
Array.prototype.unshift = function unshift() {
  ...
  if (argCount > 0) {
    ...
    if (len + argCount > 0x1FFFFFFFFFFFF) throw _TypeError('Array.prototype.unshift result out of space');
    // b. Let k be len.
    var k = len;
    // c. Repeat, while k > 0,
    while (k > 0) {
