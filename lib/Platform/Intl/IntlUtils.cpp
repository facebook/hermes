...
std::string IntlUtils::toUTF8ASCII(const std::u16string &utf16Source) {
...
std::u16string IntlUtils::toUTF16ASCII(const std::string &utf8Source) {
...
bool IntlUtils::convertToBool(const std::u16string &str) {
  return convertToBool(toUTF8ASCII(str));
}

std::string IntlUtils::toLowerASCII(std::string s) {
