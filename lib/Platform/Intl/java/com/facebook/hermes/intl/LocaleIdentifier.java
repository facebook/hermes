...
class LanguageTagsGenerated {
    ...
    static {
        ...
        // We are relying on the effect of using "static const boolean" for conditional compilation in java ..
...
class LocaleIdTokenizer {
    ...
    public LocaleIdSubtag nextSubtag() throws LocaleIdSubtagIterationFailed {
        ...
        for (mCurrentSubtagEnd = mCurrentSubtagStart; mCurrentSubtagEnd < mLocaleIdBuffer.length() && !isSubtagSeparator(mLocaleIdBuffer.charAt(mCurrentSubtagEnd)); mCurrentSubtagEnd++)
            ;
