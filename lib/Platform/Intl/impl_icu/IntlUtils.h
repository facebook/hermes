...
class IntlUtils {
 public:
   ...
   */
  static std::string toUTF8ASCII(std::u16string_view utf16Source);
   ...
   */
  static std::u16string toUTF16ASCII(std::string_view utf8Source);
   ...
   * @return a bool value.
   */
  static bool convertToBool(std::u16string_view str);
