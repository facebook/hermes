...
CallResult<HermesValue> stringPrototypeCodePointAt(void *, Runtime &runtime) {
  ...
  auto strView =
      StringPrimitive::createStringView(runtime, Handle<StringPrimitive>{lv.S});
...
CallResult<HermesValue> stringPrototypeSubstring(void *, Runtime &runtime) {
  ...
  return StringPrimitive::slice(
      runtime, Handle<StringPrimitive>{lv.S}, from, to > from ? to - from : 0);
}
...
CallResult<HermesValue> stringPrototypeToLowerCase(void *, Runtime &runtime) {
  ...
  return convertCase(runtime, Handle<StringPrimitive>{lv.res}, false, false);
}
...
CallResult<HermesValue> stringPrototypeToLocaleLowerCase(
  ...
  lv.res = std::move(*resCall);
  return convertCase(runtime, Handle<StringPrimitive>{lv.res}, false, true);
#endif
}
...
CallResult<HermesValue> stringPrototypeToUpperCase(void *, Runtime &runtime) {
  ...
  lv.res = std::move(*resCall);
  return convertCase(runtime, Handle<StringPrimitive>{lv.res}, true, false);
}
...
CallResult<HermesValue> stringPrototypeToLocaleUpperCase(
  ...
  lv.res = std::move(*resCall);
  return convertCase(runtime, Handle<StringPrimitive>{lv.res}, true, true);
#endif
}
...
CallResult<HermesValue> stringPrototypeTrim(void *, Runtime &runtime) {
  ...
  {
    auto str = StringPrimitive::createStringView(
        runtime, Handle<StringPrimitive>{lv.S});
  ...
  return StringPrimitive::slice(
      runtime, Handle<StringPrimitive>{lv.S}, beginIdx, endIdx - beginIdx);
}
...
CallResult<HermesValue> stringPrototypeTrimEnd(void *, Runtime &runtime) {
  ...
  return StringPrimitive::slice(
      runtime, Handle<StringPrimitive>{lv.S}, 0, endIdx);
}
...
CallResult<HermesValue> stringPrototypeLocaleCompare(
  ...
  StringPrimitive::createStringView(runtime, Handle<StringPrimitive>{lv.S})
      .appendUTF16String(left);
  StringPrimitive::createStringView(runtime, Handle<StringPrimitive>{lv.T})
      .appendUTF16String(right);
...
CallResult<HermesValue> stringPrototypeNormalize(void *, Runtime &runtime) {
  ...
  if (args.getArg(0).isUndefined()) {
    ...
    // exception.
    auto sv = StringPrimitive::createStringView(
        runtime, Handle<StringPrimitive>{lv.f});
...
CallResult<HermesValue> stringPrototypeRepeat(void *, Runtime &runtime) {
  ...
  for (uint32_t i = 0; i < n; ++i) {
    builderRes->appendStringPrim(Handle<StringPrimitive>{lv.S});
  }
...
CallResult<HermesValue> stringPrototypeSymbolIterator(
  ...
  return JSStringIterator::create(runtime, Handle<StringPrimitive>{lv.string})
      .getHermesValue();
}
...
CallResult<HermesValue> stringPrototypePad(void *ctx, Runtime &runtime) {
  ...
  auto addFiller = [&lv, resultLen, stringLength](StringBuilder &builder) {
    ...
    while (remaining != 0) {
      ...
      builder.appendStringPrim(Handle<StringPrimitive>{lv.filler}, length);
      remaining -= length;
    }
  };
...
CallResult<HermesValue> stringPrototypeCharAt(void *, Runtime &runtime) {
  ...
  auto result = runtime.getCharacterString(StringPrimitive::createStringView(
      runtime, Handle<StringPrimitive>{lv.S})[position]);
...
CallResult<HermesValue> stringPrototypeSlice(void *, Runtime &runtime) {
  ...
  return StringPrimitive::slice(
      runtime, Handle<StringPrimitive>{lv.S}, from, span);
}
...
CallResult<HermesValue> stringPrototypeIncludesOrStartsWith(
  ...
  auto SView =
      StringPrimitive::createStringView(runtime, Handle<StringPrimitive>{lv.S});
  auto searchStrView = StringPrimitive::createStringView(
      runtime, Handle<StringPrimitive>{lv.searchStr});
  auto foundIter = std::search(
      SView.begin() + start,
      SView.end(),
      searchStrView.begin(),
