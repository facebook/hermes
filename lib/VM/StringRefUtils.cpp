...
#if HERMES_PLATFORM_UNICODE != HERMES_PLATFORM_UNICODE_ICU
/// Print the given UTF-16. On iOS, the ucnv* family of functions is private,
/// so we simply assume UTF-8. On Android we also assume UTF-8 to avoid
/// the increased binary size of supporting encoding conversion.
