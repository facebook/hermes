...
function copyHermesBinaries() {
  ...
  // Create directories for npm/hermes-compiler-v2/hermesc binaries
  mkdir('-p', './npm/hermes-compiler-v2/hermesc/osx-bin');
  // mkdir('-p', './npm/hermes-compiler-v2/hermesc/win64-bin');
  mkdir('-p', './npm/hermes-compiler-v2/hermesc/linux64-bin');
  ...
  if (test('-d', osxReleaseDir)) {
    ...
    cp(
      ...
      './npm/hermes-compiler-v2/hermesc/osx-bin/hermesc',
    );
  ...
  //   './npm/hermes-compiler-v2/hermesc/win64-bin/.',
  // );
  ...
  cp(
    ...
    './npm/hermes-compiler-v2/hermesc/linux64-bin/.',
  );

  echo('Making hermesc files executable...');
  chmod('-R', '+x', 'npm/hermes-compiler-v2/hermesc/*');
