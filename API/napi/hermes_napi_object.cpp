...
napi_status NAPI_CDECL napi_set_property(
  ...
  auto objHandle =
      hermes::vm::Handle<hermes::vm::JSObject>::vmcast(objPhv);
...
napi_status NAPI_CDECL napi_get_property(
  ...
  hermes::vm::GCScope gcScope(env->runtime);
  auto getRes = hermes::vm::JSObject::getComputed_RJS(
      objHandle, env->runtime, keyHandle);
...
napi_status NAPI_CDECL napi_has_property(
  ...
  hermes::vm::GCScope gcScope(env->runtime);
  auto hasRes = hermes::vm::JSObject::hasComputed(
      objHandle, env->runtime, keyHandle);
...
napi_status NAPI_CDECL napi_delete_property(
  ...
  hermes::vm::GCScope gcScope(env->runtime);
  auto delRes = hermes::vm::JSObject::deleteComputed(
      objHandle, env->runtime, keyHandle);
...
napi_status NAPI_CDECL napi_set_named_property(
  ...
  hermes::vm::CallResult<hermes::vm::Handle<hermes::vm::SymbolID>>
      symRes = hermes::vm::ExecutionStatus::EXCEPTION;
  ...
  if (LLVM_UNLIKELY(
          putRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
    return captureRuntimeException(env, napi_pending_exception);
  }
...
napi_status NAPI_CDECL napi_get_named_property(
  ...
  if (LLVM_UNLIKELY(
          getRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
    return captureRuntimeException(env, napi_pending_exception);
  }
...
napi_status NAPI_CDECL napi_has_named_property(
  ...
  auto hasRes = hermes::vm::JSObject::hasNamedOrIndexed(
      objHandle, env->runtime, **symRes);
  if (LLVM_UNLIKELY(
          hasRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
    return captureRuntimeException(env, napi_pending_exception);
  }
...
napi_status NAPI_CDECL napi_get_element(
  ...
  auto idxHandle = env->runtime.makeHandle(
      hermes::vm::HermesValue::encodeTrustedNumberValue(index));
  auto getRes = hermes::vm::JSObject::getComputed_RJS(
      objHandle, env->runtime, idxHandle);
  if (LLVM_UNLIKELY(getRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
    return captureRuntimeException(env, napi_pending_exception);
  }
...
napi_status NAPI_CDECL napi_get_all_property_names(
  ...
  bool needAttrFilter = (key_filter &
  ...
  auto arrRes = hermes::vm::JSArray::create(
      ...
      0);
  if (LLVM_UNLIKELY(
          arrRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
    return captureRuntimeException(env, napi_pending_exception);
  }
  ...
  for (;;) {
    ...
    auto keysRes = hermes::vm::JSObject::getOwnPropertyKeys(
        curObj, env->runtime, okFlags);
    if (LLVM_UNLIKELY(
            keysRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
      return captureRuntimeException(env, napi_pending_exception);
    }

    auto keysArray = *keysRes;
    uint32_t len = hermes::vm::JSArray::getLength(
        keysArray.get(), env->runtime);
    ...
    for (uint32_t i = 0; i < len; ++i) {
      ...
      if (elem.isNumber()) {
        ...
        dedupKey = (static_cast<uintptr_t>(
                        static_cast<uint32_t>(elem.getNumber()))
                    << 1) |
            1;
      ...
      if (needAttrFilter) {
        ...
        tmpHandle = elem;
        auto found =
            hermes::vm::JSObject::getOwnComputedDescriptor(
                curObj,
                env->runtime,
                tmpHandle,
                desc);
        if (LLVM_UNLIKELY(
                found == hermes::vm::ExecutionStatus::EXCEPTION)) {
      ...
      if (key_conversion == napi_key_numbers_to_strings &&
          elem.isNumber()) {
        auto strRes = hermes::vm::toString_RJS(
            env->runtime, tmpHandle);
        if (LLVM_UNLIKELY(
                strRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
          return captureRuntimeException(
              env, napi_pending_exception);
        }
    ...
    if (LLVM_UNLIKELY(
            protoRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
      return captureRuntimeException(env, napi_pending_exception);
    }
    if (!protoRes->get())
      break;
  ...
  if (resultIndex > 0) {
    ...
    if (LLVM_UNLIKELY(
            setLenRes == hermes::vm::ExecutionStatus::EXCEPTION)) {
      return captureRuntimeException(env, napi_pending_exception);
    }
  }
...
napi_status NAPI_CDECL napi_has_own_property(
  ...
  RETURN_STATUS_IF_FALSE(
      env,
      keyPhv->isString() || keyPhv->isSymbol(),
      napi_name_expected);
...
napi_status NAPI_CDECL napi_get_prototype(
  ...
  if (proto) {
    ...
    *result = env->addToCurrentScope(
        hermes::vm::HermesValue::encodeNullValue());
  }
...
napi_status NAPI_CDECL napi_define_properties(
  ...
  for (size_t i = 0; i < property_count; ++i) {
    ...
    if (p->utf8name != nullptr) {
      ...
      auto *namePhv =
          reinterpret_cast<PinnedHermesValue *>(p->name);
      RETURN_STATUS_IF_FALSE(
          env,
          namePhv != nullptr &&
              (namePhv->isString() || namePhv->isSymbol()),
          napi_name_expected);
    ...
    if (p->getter != nullptr || p->setter != nullptr) {
      ...
      if (p->getter != nullptr) {
        ...
        getterHandle = runtime.makeHandle<Callable>(
            getterFunc.getHermesValue());
      }
      if (p->setter != nullptr) {
        PseudoHandle<NativeFunction> setterFunc{};
        STATUS_CALL(createNapiNativeFunction(
            env, p->setter, p->data, propertySym, 1, setterFunc));
        setterHandle = runtime.makeHandle<Callable>(
            setterFunc.getHermesValue());
      }

      auto accessor =
          PropertyAccessor::create(runtime, getterHandle, setterHandle);
      auto accessorHandle =
          runtime.makeHandle(accessor.getHermesValue());
      ...
      auto methodHandle =
          runtime.makeHandle(methodFunc.getHermesValue());
      ...
      auto *valPhv =
          reinterpret_cast<PinnedHermesValue *>(p->value);
...
napi_object_freeze(napi_env env, napi_value object) {
  ...
  auto *objPhv =
      reinterpret_cast<hermes::vm::PinnedHermesValue *>(object);
  RETURN_STATUS_IF_FALSE(
      env, objPhv->isObject(), napi_object_expected);
