...
├── JSIUtils.h/cpp        # Shared utility functions for extensions
...
The `JSIUtils.h` header provides common utilities for working with JSI, such as TypedArray buffer access and safe integer conversion. Include it to get `Intrinsics.h` as well. See the header for documentation.
