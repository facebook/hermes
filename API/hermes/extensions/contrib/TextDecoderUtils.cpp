...
llvh::Optional<TextDecoderEncoding> parseEncodingLabel(llvh::StringRef label) {
  llvh::StringRef trimmed = label.trim();
  ...
  if (trimmed.equals_lower("unicodefffe") || trimmed.equals_lower("utf-16be")) {
  ...
  if (trimmed.equals_lower("csisolatin2") ||
      trimmed.equals_lower("iso-8859-2") ||
  ...
  if (trimmed.equals_lower("csisolatin3") ||
      trimmed.equals_lower("iso-8859-3") ||
  ...
  if (trimmed.equals_lower("csisolatin4") ||
      trimmed.equals_lower("iso-8859-4") ||
  ...
  if (trimmed.equals_lower("csisolatincyrillic") ||
      trimmed.equals_lower("cyrillic") || trimmed.equals_lower("iso-8859-5") ||
      trimmed.equals_lower("iso-ir-144") || trimmed.equals_lower("iso8859-5") ||
      trimmed.equals_lower("iso88595") || trimmed.equals_lower("iso_8859-5") ||
      trimmed.equals_lower("iso_8859-5:1988")) {
    return TextDecoderEncoding::ISO_8859_5;
  }

  if (trimmed.equals_lower("arabic") || trimmed.equals_lower("asmo-708") ||
      trimmed.equals_lower("csiso88596e") ||
      trimmed.equals_lower("csiso88596i") ||
      trimmed.equals_lower("csisolatinarabic") ||
      trimmed.equals_lower("ecma-114") || trimmed.equals_lower("iso-8859-6") ||
      trimmed.equals_lower("iso-8859-6-e") ||
      trimmed.equals_lower("iso-8859-6-i") ||
      trimmed.equals_lower("iso-ir-127") || trimmed.equals_lower("iso8859-6") ||
      trimmed.equals_lower("iso88596") || trimmed.equals_lower("iso_8859-6") ||
      trimmed.equals_lower("iso_8859-6:1987")) {
    return TextDecoderEncoding::ISO_8859_6;
  }

  if (trimmed.equals_lower("csisolatingreek") ||
      trimmed.equals_lower("ecma-118") || trimmed.equals_lower("elot_928") ||
      trimmed.equals_lower("greek") || trimmed.equals_lower("greek8") ||
      trimmed.equals_lower("iso-8859-7") ||
      ...
      trimmed.equals_lower("iso_8859-7:1987") ||
      trimmed.equals_lower("sun_eu_greek")) {
    return TextDecoderEncoding::ISO_8859_7;
  }

  if (trimmed.equals_lower("csiso88598e") ||
      trimmed.equals_lower("csisolatinhebrew") ||
      trimmed.equals_lower("hebrew") || trimmed.equals_lower("iso-8859-8") ||
      trimmed.equals_lower("iso-8859-8-e") ||
      trimmed.equals_lower("iso-ir-138") || trimmed.equals_lower("iso8859-8") ||
      trimmed.equals_lower("iso88598") || trimmed.equals_lower("iso_8859-8") ||
      trimmed.equals_lower("iso_8859-8:1988") ||
      trimmed.equals_lower("visual")) {
    return TextDecoderEncoding::ISO_8859_8;
  }

  if (trimmed.equals_lower("csiso88598i") ||
      trimmed.equals_lower("iso-8859-8-i") || trimmed.equals_lower("logical")) {
    return TextDecoderEncoding::ISO_8859_8_I;
  }

  if (trimmed.equals_lower("csisolatin6") ||
      trimmed.equals_lower("iso-8859-10") ||
      trimmed.equals_lower("iso-ir-157") ||
      trimmed.equals_lower("iso8859-10") || trimmed.equals_lower("iso885910") ||
      trimmed.equals_lower("l6") || trimmed.equals_lower("latin6")) {
    return TextDecoderEncoding::ISO_8859_10;
  }

  if (trimmed.equals_lower("iso-8859-13") ||
      trimmed.equals_lower("iso8859-13") || trimmed.equals_lower("iso885913")) {
    return TextDecoderEncoding::ISO_8859_13;
  }

  if (trimmed.equals_lower("iso-8859-14") ||
      trimmed.equals_lower("iso8859-14") || trimmed.equals_lower("iso885914")) {
    return TextDecoderEncoding::ISO_8859_14;
  }

  if (trimmed.equals_lower("csisolatin9") ||
      trimmed.equals_lower("iso-8859-15") ||
  ...
  if (trimmed.equals_lower("csmacintosh") || trimmed.equals_lower("mac") ||
      trimmed.equals_lower("macintosh") ||
      trimmed.equals_lower("x-mac-roman")) {
  ...
  if (trimmed.equals_lower("ansi_x3.4-1968") || trimmed.equals_lower("ascii") ||
      ...
      trimmed.equals_lower("iso-8859-1") ||
      trimmed.equals_lower("iso-ir-100") || trimmed.equals_lower("iso8859-1") ||
      trimmed.equals_lower("iso88591") || trimmed.equals_lower("iso_8859-1") ||
      trimmed.equals_lower("iso_8859-1:1987") || trimmed.equals_lower("l1") ||
      trimmed.equals_lower("latin1") || trimmed.equals_lower("us-ascii") ||
      trimmed.equals_lower("windows-1252") ||
  ...
  if (trimmed.equals_lower("cp1254") || trimmed.equals_lower("csisolatin5") ||
      trimmed.equals_lower("iso-8859-9") ||
      trimmed.equals_lower("iso-ir-148") || trimmed.equals_lower("iso8859-9") ||
      trimmed.equals_lower("iso88599") || trimmed.equals_lower("iso_8859-9") ||
      trimmed.equals_lower("iso_8859-9:1989") || trimmed.equals_lower("l5") ||
      trimmed.equals_lower("latin5") || trimmed.equals_lower("windows-1254") ||
      trimmed.equals_lower("x-cp1254")) {
  ...
  while (p < end) {
    ...
    if (isHighSurrogate(cu)) {
      if (p + 4 <= end) {
        ...
        // The odd byte would have been part of the low surrogate that never
        // came.
        if (fatal) {
...
static constexpr char16_t kKOI8_U[128] = {
    ...
    0x0491, 0x045E, 0x255E, 0x255F, 0x2560, 0x2561, 0x0401, 0x0404, 0x2563,
    0x0406, 0x0407, 0x2566, 0x2567, 0x2568, 0x2569, 0x256A, 0x0490, 0x040E,
    0x00A9, 0x044E, 0x0430, 0x0431, 0x0446, 0x0434, 0x0435, 0x0444, 0x0433,
    0x0445, 0x0438, 0x0439, 0x043A, 0x043B, 0x043C, 0x043D, 0x043E, 0x043F,
    0x044F, 0x0440, 0x0441, 0x0442, 0x0443, 0x0436, 0x0432, 0x044C, 0x044B,
    0x0437, 0x0448, 0x044D, 0x0449, 0x0447, 0x044A, 0x042E, 0x0410, 0x0411,
...
static constexpr char16_t kWindows874[128] = {
    0x20AC, 0x0081, 0x0082, 0x0083, 0x0084, 0x2026, 0x0086, 0x0087, 0x0088,
    0x0089, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F, 0x0090, 0x2018,
    0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x0098, 0x0099, 0x009A,
...
static constexpr char16_t kWindows1250[128] = {
    0x20AC, 0x0081, 0x201A, 0x0083, 0x201E, 0x2026, 0x2020, 0x2021, 0x0088,
    0x2030, 0x0160, 0x2039, 0x015A, 0x0164, 0x017D, 0x0179, 0x0090, 0x2018,
    0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x0098, 0x2122, 0x0161,
...
static constexpr char16_t kWindows1253[128] = {
    0x20AC, 0x0081, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021, 0x0088,
    0x2030, 0x008A, 0x2039, 0x008C, 0x008D, 0x008E, 0x008F, 0x0090, 0x2018,
    0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x0098, 0x2122, 0x009A,
    0x203A, 0x009C, 0x009D, 0x009E, 0x009F, 0x00A0, 0x0385, 0x0386, 0x00A3,
    0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0xFFFD, 0x00AB, 0x00AC,
...
static constexpr char16_t kWindows1254[128] = {
    0x20AC, 0x0081, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021, 0x02C6,
    0x2030, 0x0160, 0x2039, 0x0152, 0x008D, 0x008E, 0x008F, 0x0090, 0x2018,
    0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x02DC, 0x2122, 0x0161,
    0x203A, 0x0153, 0x009D, 0x009E, 0x0178, 0x00A0, 0x00A1, 0x00A2, 0x00A3,
    0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x00AA, 0x00AB, 0x00AC,
    0x00AD, 0x00AE, 0x00AF, 0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x00B4, 0x00B5,
    0x00B6, 0x00B7, 0x00B8, 0x00B9, 0x00BA, 0x00BB, 0x00BC, 0x00BD, 0x00BE,
    0x00BF, 0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7,
...
static constexpr char16_t kWindows1255[128] = {
    0x20AC, 0x0081, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021, 0x02C6,
    0x2030, 0x008A, 0x2039, 0x008C, 0x008D, 0x008E, 0x008F, 0x0090, 0x2018,
    0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x02DC, 0x2122, 0x009A,
    0x203A, 0x009C, 0x009D, 0x009E, 0x009F, 0x00A0, 0x00A1, 0x00A2, 0x00A3,
    ...
    0x05B8, 0x05B9, 0x05BA, 0x05BB, 0x05BC, 0x05BD, 0x05BE, 0x05BF, 0x05C0,
    0x05C1, 0x05C2, 0x05C3, 0x05F0, 0x05F1, 0x05F2, 0x05F3, 0x05F4, 0xFFFD,
    0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0x05D0, 0x05D1, 0x05D2,
    0x05D3, 0x05D4, 0x05D5, 0x05D6, 0x05D7, 0x05D8, 0x05D9, 0x05DA, 0x05DB,
    0x05DC, 0x05DD, 0x05DE, 0x05DF, 0x05E0, 0x05E1, 0x05E2, 0x05E3, 0x05E4,
    0x05E5, 0x05E6, 0x05E7, 0x05E8, 0x05E9, 0x05EA, 0xFFFD, 0xFFFD, 0x200E,
    0x200F, 0xFFFD};
...
static constexpr char16_t kWindows1257[128] = {
    0x20AC, 0x0081, 0x201A, 0x0083, 0x201E, 0x2026, 0x2020, 0x2021, 0x0088,
    0x2030, 0x008A, 0x2039, 0x008C, 0x00A8, 0x02C7, 0x00B8, 0x0090, 0x2018,
    0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x0098, 0x2122, 0x009A,
    0x203A, 0x009C, 0x00AF, 0x02DB, 0x009F, 0x00A0, 0xFFFD, 0x00A2, 0x00A3,
    0x00A4, 0xFFFD, 0x00A6, 0x00A7, 0x00D8, 0x00A9, 0x0156, 0x00AB, 0x00AC,
...
static constexpr char16_t kWindows1258[128] = {
    0x20AC, 0x0081, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021, 0x02C6,
    0x2030, 0x008A, 0x2039, 0x0152, 0x008D, 0x008E, 0x008F, 0x0090, 0x2018,
    0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x02DC, 0x2122, 0x009A,
    0x203A, 0x0153, 0x009D, 0x009E, 0x0178, 0x00A0, 0x00A1, 0x00A2, 0x00A3,
    0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x00AA, 0x00AB, 0x00AC,
    0x00AD, 0x00AE, 0x00AF, 0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x00B4, 0x00B5,
...
const std::array<const char16_t *, kNumSingleByteEncodings>
