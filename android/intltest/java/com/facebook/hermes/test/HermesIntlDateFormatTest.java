        ...
        new HashSet<>(
            Arrays.asList(
                ...
                "constructor-options-fractionalSecondDigits-invalid.js", // new
                                                                         // Intl.DateTimeFormat("en", { fractionalSecondDigits: "LONG" }) throws RangeError Expected a RangeError to be thrown but no exception was thrown at all
                ...
                "constructor-options-throwing-getters-fractionalSecondDigits.js", // Exception from
                                                                                  // fractionalSecondDigits getter should be propagated Expected a CustomError to be thrown but no exception was thrown at all
