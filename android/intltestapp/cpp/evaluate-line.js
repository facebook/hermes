...
C_STRING((function() {
  ...
  function populateColors() {
    colors.red = "<font color='#FF0000'>"; //'\033[31m';
    colors.green = "<font color='#00FF00'>"; //\033[32m';
    colors.yellow = "<font color='#FFFF00'>"; //'\033[33m';
    colors.blue = "<font color='#0000FF'>"; //'\033[34m';
    colors.magenta = "<font color='#FF00FF'>"; //'\033[35m';
    colors.cyan = "<font color='#00FFFF'>"; //'\033[36m';
    colors.white = "<font color='#FFFFFF'>"; //'\033[37m';

    colors.reset = '</font>'; //'\033[0m';
  }
