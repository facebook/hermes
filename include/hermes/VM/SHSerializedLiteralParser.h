...
#ifndef HERMES_VM_SHSERIALIZEDLITERALPARSER_H
#define HERMES_VM_SHSERIALIZEDLITERALPARSER_H
...
class SHSerializedLiteralParser : public hbc::SerializedLiteralParserBase {
  /// Stores the SHRuntime the code is running in.
 ...
 public:
  ...
  explicit SHSerializedLiteralParser(
      CharArray buff,
      unsigned int totalLen,
      SHUnit *unit)
      : SerializedLiteralParserBase(buff, totalLen), unit_(unit) {}
...
#endif // HERMES_VM_SHSERIALIZEDLITERALPARSER_H
