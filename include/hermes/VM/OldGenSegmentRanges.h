...
class OldGenFilledSegmentRange : public GCSegmentRange {
 public:
  ...
  inline OldGenFilledSegmentRange(OldGen *gen);
...
/* static */
inline GCSegmentRange::Ptr OldGenFilledSegmentRange::create(OldGen *gen) {
  return std::unique_ptr<OldGenFilledSegmentRange>(
      new OldGenFilledSegmentRange{gen});
}

inline OldGenFilledSegmentRange::OldGenFilledSegmentRange(OldGen *gen)
    : gen_{gen} {}
