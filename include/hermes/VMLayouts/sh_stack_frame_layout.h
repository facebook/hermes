...
#ifndef HERMES_SH_STACK_FRAME_LAYOUT_H
#define HERMES_SH_STACK_FRAME_LAYOUT_H
...
///
enum SHStackFrameLayout {
  /// Offset of the first local register.
  SHStackFrame_FirstLocal = 1,
  ...
  SHStackFrame_CalleeClosureOrCB = -7,
  /// The "this" argument.
  SHStackFrame_ThisArg = -8,
  /// The first explicit argument.
  SHStackFrame_FirstArg = -9,
  ...
  SHStackFrame_CallerExtraRegistersAtEnd =
      SHStackFrame_PreviousFrame - SHStackFrame_CalleeClosureOrCB + 1,

  /// The number of additional registers the callee needs to allocate in the
  /// beginning of its frame.
  SHStackFrame_CalleeExtraRegistersAtStart =
      SHStackFrame_FirstLocal - SHStackFrame_DebugEnvironment,
};
...
#endif // HERMES_SH_STACK_FRAME_LAYOUT_H
