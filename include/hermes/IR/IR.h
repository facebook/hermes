...
class Module : public Value {
 ...
 public:
  ...
  /// \return (rawStrings, template ID) where rawStrings is valid until
  ///   getTemplateObjectID is called again.
  std::pair<const Module::RawStringList &, uint32_t> getTemplateObjectID(
