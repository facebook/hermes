...
// Vendored from Node.js v24 src/js_native_api.h with modifications:
// - Include guard renamed to avoid conflicts with Node.js headers
// - NAPI_EXTERN defaults to visibility("default") for shared library builds

#ifndef HERMES_NAPI_JS_NATIVE_API_H_
#define HERMES_NAPI_JS_NATIVE_API_H_
...
#endif  // HERMES_NAPI_JS_NATIVE_API_H_
