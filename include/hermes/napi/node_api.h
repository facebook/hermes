...
// Vendored from Node.js v24 src/node_api.h with modifications:
// - Include guard renamed to avoid conflicts with Node.js headers

#ifndef HERMES_NAPI_NODE_API_H_
#define HERMES_NAPI_NODE_API_H_
...
#define NODE_API_MODULE_GET_API_VERSION_BASE                                   \
...
// Hermes does not use libuv; this will return napi_generic_failure.
NAPI_EXTERN napi_status NAPI_CDECL
