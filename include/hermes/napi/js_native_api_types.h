...
// Vendored from Node.js v24 src/js_native_api_types.h with modifications:
// - NAPI_VERSION default set to 10 (Hermes target version)
// - Include guard renamed to avoid conflicts with Node.js headers

#ifndef HERMES_NAPI_JS_NATIVE_API_TYPES_H_
#define HERMES_NAPI_JS_NATIVE_API_TYPES_H_
...
#else
// Hermes targets NAPI version 10.
...
// the error_messages array in the implementation file.
...
#endif  // HERMES_NAPI_JS_NATIVE_API_TYPES_H_
