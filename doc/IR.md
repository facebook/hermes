...
--- | --- |
Description | Raises an exception if the given name is the name of a global object property that may not be shadowed (i.e., redeclared) by a global lexical binding.
