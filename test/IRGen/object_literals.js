...
// CHECK-NEXT:  %1 = StorePropertyInst %0 : closure, globalObject : object, "simpleObjectLiteral" : string
// CHECK-NEXT:  %2 = CreateFunctionInst %emitAllocObjectLiteral()
// CHECK-NEXT:  %3 = StorePropertyInst %2 : closure, globalObject : object, "emitAllocObjectLiteral" : string
// CHECK-NEXT:  %4 = CreateFunctionInst %nestedAllocObjectLiteral()
// CHECK-NEXT:  %5 = StorePropertyInst %4 : closure, globalObject : object, "nestedAllocObjectLiteral" : string
// CHECK-NEXT:  %6 = CreateFunctionInst %duplicatedObjectLiteral()
// CHECK-NEXT:  %7 = StorePropertyInst %6 : closure, globalObject : object, "duplicatedObjectLiteral" : string
// CHECK-NEXT:  %8 = CreateFunctionInst %emptyObjectLiteral()
// CHECK-NEXT:  %9 = StorePropertyInst %8 : closure, globalObject : object, "emptyObjectLiteral" : string
// CHECK-NEXT:  %10 = CreateFunctionInst %protoObjectLiteral1()
// CHECK-NEXT:  %11 = StorePropertyInst %10 : closure, globalObject : object, "protoObjectLiteral1" : string
// CHECK-NEXT:  %12 = CreateFunctionInst %protoObjectLiteral2()
// CHECK-NEXT:  %13 = StorePropertyInst %12 : closure, globalObject : object, "protoObjectLiteral2" : string
// CHECK-NEXT:  %14 = CreateFunctionInst %computedObjectLiteral()
// CHECK-NEXT:  %15 = StorePropertyInst %14 : closure, globalObject : object, "computedObjectLiteral" : string
// CHECK-NEXT:  %16 = CreateFunctionInst %spreadObjectLiteral()
// CHECK-NEXT:  %17 = StorePropertyInst %16 : closure, globalObject : object, "spreadObjectLiteral" : string
// CHECK-NEXT:  %18 = CreateFunctionInst %accessorObjectLiteral1()
// CHECK-NEXT:  %19 = StorePropertyInst %18 : closure, globalObject : object, "accessorObjectLiteral1" : string
// CHECK-NEXT:  %20 = CreateFunctionInst %accessorObjectLiteral2()
// CHECK-NEXT:  %21 = StorePropertyInst %20 : closure, globalObject : object, "accessorObjectLiteral2" : string
