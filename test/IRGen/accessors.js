...
//CHECK-NEXT:  %4 = StoreGetterSetterInst %3 : closure, undefined : undefined, %2 : object, "a" : string
//CHECK-NEXT:  %5 = CreateFunctionInst %"get 1"()
//CHECK-NEXT:  %6 = CreateFunctionInst %"set 1"()
//CHECK-NEXT:  %7 = StoreGetterSetterInst %5 : closure, %6 : closure, %2 : object, "1" : string
//CHECK-NEXT:  %8 = StoreOwnPropertyInst 12 : number, %2 : object, "b" : string
