...
// CHECK-NEXT:  %3 = StorePropertyLooseInst %2: object, globalObject: object, "foo1": string
// CHECK-NEXT:  %4 = CreateFunctionInst (:object) %foo2(): any
// CHECK-NEXT:  %5 = StorePropertyLooseInst %4: object, globalObject: object, "foo2": string
