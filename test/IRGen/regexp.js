...
// CHECK-NEXT:%BB0:
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [re]: any
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [str]: any
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [newstr]: any
// CHECK-NEXT:  %3 = CreateRegExpInst (:object) "(\\\\w+)\\\\s(\\\\w+)": string, "": string
// CHECK-NEXT:       StoreFrameInst %3: object, [re]: any
// CHECK-NEXT:       StoreFrameInst "John Smith": string, [str]: any
...
// CHECK-NEXT:        StoreFrameInst %9: any, [newstr]: any
...
// CHECK-NEXT:%BB0:
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [re0]: any
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [re1]: any
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [re2]: any
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [re3]: any
// CHECK-NEXT:       StoreFrameInst undefined: undefined, [re4]: any
// CHECK-NEXT:  %5 = CreateRegExpInst (:object) "\\\\w+\\\\s": string, "g": string
// CHECK-NEXT:       StoreFrameInst %5: object, [re0]: any
// CHECK-NEXT:  %7 = CreateRegExpInst (:object) "\\\\w+\\\\s": string, "g": string
// CHECK-NEXT:       StoreFrameInst %7: object, [re1]: any
// CHECK-NEXT:  %9 = CreateRegExpInst (:object) "\\\\w+": string, "": string
// CHECK-NEXT:        StoreFrameInst %9: object, [re2]: any
// CHECK-NEXT:  %11 = CreateRegExpInst (:object) "\\\\w+": string, "g": string
// CHECK-NEXT:        StoreFrameInst %11: object, [re3]: any
// CHECK-NEXT:  %13 = CreateRegExpInst (:object) " ": string, "": string
// CHECK-NEXT:        StoreFrameInst %13: object, [re4]: any
// CHECK-NEXT:        ReturnInst undefined: undefined
// CHECK-NEXT:function_end
