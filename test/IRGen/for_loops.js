...
// CHECK-NEXT:  %10 = StorePropertyLooseInst %9: object, globalObject: object, "sink": string
// CHECK-NEXT:  %11 = CreateFunctionInst (:object) %simple_for_loop(): any
// CHECK-NEXT:  %12 = StorePropertyLooseInst %11: object, globalObject: object, "simple_for_loop": string
// CHECK-NEXT:  %13 = CreateFunctionInst (:object) %simple_for_loop_break(): any
// CHECK-NEXT:  %14 = StorePropertyLooseInst %13: object, globalObject: object, "simple_for_loop_break": string
// CHECK-NEXT:  %15 = CreateFunctionInst (:object) %simple_for_loop_break_label(): any
// CHECK-NEXT:  %16 = StorePropertyLooseInst %15: object, globalObject: object, "simple_for_loop_break_label": string
// CHECK-NEXT:  %17 = CreateFunctionInst (:object) %simple_for_loop_continue(): any
// CHECK-NEXT:  %18 = StorePropertyLooseInst %17: object, globalObject: object, "simple_for_loop_continue": string
// CHECK-NEXT:  %19 = CreateFunctionInst (:object) %simple_for_loop_continue_label(): any
// CHECK-NEXT:  %20 = StorePropertyLooseInst %19: object, globalObject: object, "simple_for_loop_continue_label": string
// CHECK-NEXT:  %21 = CreateFunctionInst (:object) %for_loop_match(): any
// CHECK-NEXT:  %22 = StorePropertyLooseInst %21: object, globalObject: object, "for_loop_match": string
// CHECK-NEXT:  %23 = CreateFunctionInst (:object) %naked_for_loop(): any
// CHECK-NEXT:  %24 = StorePropertyLooseInst %23: object, globalObject: object, "naked_for_loop": string
// CHECK-NEXT:  %25 = CreateFunctionInst (:object) %test_init_update_exprs(): any
// CHECK-NEXT:  %26 = StorePropertyLooseInst %25: object, globalObject: object, "test_init_update_exprs": string
