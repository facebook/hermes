...
// CHECK-NEXT:  %7 = StorePropertyLooseInst %6: object, globalObject: object, "bar": string
// CHECK-NEXT:  %8 = CreateFunctionInst (:object) %continue_test(): any
// CHECK-NEXT:  %9 = StorePropertyLooseInst %8: object, globalObject: object, "continue_test": string
// CHECK-NEXT:  %10 = CreateFunctionInst (:object) %break_test(): any
// CHECK-NEXT:  %11 = StorePropertyLooseInst %10: object, globalObject: object, "break_test": string
// CHECK-NEXT:  %12 = CreateFunctionInst (:object) %break_label(): any
// CHECK-NEXT:  %13 = StorePropertyLooseInst %12: object, globalObject: object, "break_label": string
// CHECK-NEXT:  %14 = CreateFunctionInst (:object) %continue_label(): any
// CHECK-NEXT:  %15 = StorePropertyLooseInst %14: object, globalObject: object, "continue_label": string
// CHECK-NEXT:  %16 = CreateFunctionInst (:object) %nested_label(): any
// CHECK-NEXT:  %17 = StorePropertyLooseInst %16: object, globalObject: object, "nested_label": string
