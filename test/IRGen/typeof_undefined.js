// RUN: %hermes -hermes-parser -dump-ir -strict %s 2>&1 | %FileCheck %s --match-full-lines

var x = typeof foo;


//CHECK:      {{.*}}typeof_undefined.js:3:16: warning: the variable "foo" was not declared in function "global"
