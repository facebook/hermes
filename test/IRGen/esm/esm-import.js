...
// CHECK-NEXT:S{cjs_module#0#1()#2} = [exports#2, require#2, module#2, Foo#2, defaultFoo#2, x#2, z#2]
// CHECK-NEXT:%BB0:
...
// CHECK-NEXT:  %8 = CallInst %require, undefined : undefined, undefined : undefined, "foo.js" : string
// CHECK-NEXT:  %9 = StoreFrameInst %8, [Foo#2], %0
// CHECK-NEXT:  %10 = CallInst %require, undefined : undefined, undefined : undefined, "foo.js" : string
// CHECK-NEXT:  %11 = LoadPropertyInst %10, "?default" : string
// CHECK-NEXT:  %12 = StoreFrameInst %11, [defaultFoo#2], %0
// CHECK-NEXT:  %13 = CallInst %require, undefined : undefined, undefined : undefined, "foo.js" : string
...
// CHECK-NEXT:  %18 = CallInst %require, undefined : undefined, undefined : undefined, "bar.js" : string
