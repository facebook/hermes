...
// CHECK-NEXT:  %12 = CreateFunctionInst (:object) %0: environment, %myFun(): functionCode
// CHECK-NEXT:        StoreFrameInst %0: environment, %12: object, [%VS1.myFun]: any
// CHECK-NEXT:  %14 = LoadFrameInst (:any) %0: environment, [%VS1.myFun]: any
// CHECK-NEXT:        StorePropertyLooseInst %14: any, %1: any, "myFun": string
// CHECK-NEXT:        StoreFrameInst %0: environment, 1: number, [%VS1.x]: any
// CHECK-NEXT:  %17 = LoadFrameInst (:any) %0: environment, [%VS1.x]: any
// CHECK-NEXT:        StorePropertyLooseInst %17: any, %1: any, "x": string
// CHECK-NEXT:        StoreFrameInst %0: environment, 2: number, [%VS1.y]: any
// CHECK-NEXT:  %20 = LoadFrameInst (:any) %0: environment, [%VS1.y]: any
// CHECK-NEXT:        StorePropertyLooseInst %20: any, %1: any, "y": string
// CHECK-NEXT:        StoreFrameInst %0: environment, 4: number, [%VS1.z]: any
// CHECK-NEXT:  %23 = LoadFrameInst (:any) %0: environment, [%VS1.z]: any
// CHECK-NEXT:        StorePropertyLooseInst %23: any, %1: any, "z": string
...
// CHECK-NEXT:  %27 = LoadFrameInst (:any) %0: environment, [%VS1.a]: any
// CHECK-NEXT:        StorePropertyLooseInst %27: any, %1: any, "a": string
// CHECK-NEXT:  %29 = LoadFrameInst (:any) %0: environment, [%VS1.longVariableName]: any
// CHECK-NEXT:        StorePropertyLooseInst %29: any, %1: any, "b": string
// CHECK-NEXT:  %31 = CallInst (:any) %3: any, empty: any, empty: any, undefined: undefined, undefined: undefined, "foo.js": string
// CHECK-NEXT:  %32 = CallBuiltinInst (:any) [HermesBuiltin.exportAll]: number, empty: any, empty: any, undefined: undefined, undefined: undefined, %1: any, %31: any
