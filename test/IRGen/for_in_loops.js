...
// CHECK-NEXT:  %9 = StorePropertyLooseInst %8: object, globalObject: object, "simple_for_in_loop": string
// CHECK-NEXT:  %10 = CreateFunctionInst (:object) %for_in_loop_with_break_continue(): any
// CHECK-NEXT:  %11 = StorePropertyLooseInst %10: object, globalObject: object, "for_in_loop_with_break_continue": string
// CHECK-NEXT:  %12 = CreateFunctionInst (:object) %for_in_loop_with_named_break(): any
// CHECK-NEXT:  %13 = StorePropertyLooseInst %12: object, globalObject: object, "for_in_loop_with_named_break": string
// CHECK-NEXT:  %14 = CreateFunctionInst (:object) %check_var_decl_for_in_loop(): any
// CHECK-NEXT:  %15 = StorePropertyLooseInst %14: object, globalObject: object, "check_var_decl_for_in_loop": string
// CHECK-NEXT:  %16 = CreateFunctionInst (:object) %loop_member_expr_lhs(): any
// CHECK-NEXT:  %17 = StorePropertyLooseInst %16: object, globalObject: object, "loop_member_expr_lhs": string
...
// CHECK-NEXT:  %11 = GetPNamesInst %4: any, %5: any, %6: number, %7: number, %BB1, %BB2
// CHECK-NEXT:%BB1:
// CHECK-NEXT:  %12 = ReturnInst undefined: undefined
// CHECK-NEXT:%BB2:
// CHECK-NEXT:  %13 = GetNextPNameInst %10: any, %5: any, %6: number, %7: number, %4: any, %BB1, %BB3
// CHECK-NEXT:%BB3:
...
// CHECK-NEXT:%BB2:
// CHECK-NEXT:  %14 = GetNextPNameInst %10: any, %5: any, %6: number, %7: number, %4: any, %BB1, %BB4
// CHECK-NEXT:%BB4:
...
// CHECK-NEXT:%BB2:
// CHECK-NEXT:  %16 = GetNextPNameInst %9: any, %4: any, %5: number, %6: number, %3: any, %BB1, %BB3
// CHECK-NEXT:%BB3:
