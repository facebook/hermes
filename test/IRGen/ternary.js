...
// CHECK-NEXT:  %4 = StorePropertyLooseInst %3: object, globalObject: object, "test_one": string
// CHECK-NEXT:  %5 = CreateFunctionInst (:object) %test_two(): any
// CHECK-NEXT:  %6 = StorePropertyLooseInst %5: object, globalObject: object, "test_two": string
// CHECK-NEXT:  %7 = CreateFunctionInst (:object) %test_three(): any
// CHECK-NEXT:  %8 = StorePropertyLooseInst %7: object, globalObject: object, "test_three": string
