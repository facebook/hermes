...
// CHECK-NEXT:        CondBranchInst %9: boolean, %BB5, %BB4
// CHECK-NEXT:%BB4:
...
// CHECK-NEXT:        SaveAndYieldInst %16: any, %BB6
// CHECK-NEXT:%BB4:
// CHECK-NEXT:        ReturnInst undefined: undefined
// CHECK-NEXT:%BB5:
// CHECK-NEXT:        CondBranchInst true: boolean, %BB3, %BB4
...
// CHECK-NEXT:        CondBranchInst %22: boolean, %BB8, %BB7
// CHECK-NEXT:%BB7:
...
// CHECK-NEXT:        CondBranchInst %23: any, %BB5, %BB4
// CHECK-NEXT:%BB4:
...
// CHECK-NEXT:        CmpBrStrictlyEqualInst %33: any, undefined: undefined, %BB18, %BB17
// CHECK-NEXT:%BB9:
...
// CHECK-NEXT:        CondBranchInst %37: boolean, %BB10, %BB7
// CHECK-NEXT:%BB10:
// CHECK-NEXT:        StoreStackInst %35: any, %13: any
...
// CHECK-NEXT:        BranchInst %BB5
// CHECK-NEXT:%BB5:
// CHECK-NEXT:  %17 = PhiInst (:any) %7: any, %BB1, %15: any, %BB4
...
// CHECK-NEXT:        CondBranchInst %24: boolean, %BB10, %BB9
// CHECK-NEXT:%BB9:
// CHECK-NEXT:        ReturnInst undefined: undefined
// CHECK-NEXT:%BB10:
// CHECK-NEXT:        ReturnInst %23: any
