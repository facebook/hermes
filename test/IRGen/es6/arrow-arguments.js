...
// CHECK-NEXT:  %1 = StorePropertyInst %0 : closure, globalObject : object, "normal" : string
// CHECK-NEXT:  %2 = CreateFunctionInst %foo()
// CHECK-NEXT:  %3 = StorePropertyInst %2 : closure, globalObject : object, "foo" : string
// CHECK-NEXT:  %4 = CreateFunctionInst %bar()
// CHECK-NEXT:  %5 = StorePropertyInst %4 : closure, globalObject : object, "bar" : string
