...
// CHECK-NEXT:  %5 = AllocStackInst (:any) $nextIndex: any
// CHECK-NEXT:  %6 = StoreStackInst 0: number, %5: any
// CHECK-NEXT:  %7 = LoadFrameInst (:any) [x]: any
// CHECK-NEXT:  %8 = AllocArrayInst (:object) 0: number
// CHECK-NEXT:  %9 = LoadStackInst (:any) %5: any
// CHECK-NEXT:  %10 = CallBuiltinInst (:any) [HermesBuiltin.arraySpread]: number, empty: any, empty: any, undefined: undefined, %8: object, %7: any, %9: any
// CHECK-NEXT:  %11 = StoreStackInst %10: any, %5: any
...
// CHECK-NEXT:  %14 = AllocStackInst (:any) $nextIndex: any
...
// CHECK-NEXT:  %18 = LoadStackInst (:any) %14: any
