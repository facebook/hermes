...
// CHECK-NEXT:  %5 = StoreGetterSetterInst %4: object, undefined: undefined, %2: object, "y": string, true: boolean
// CHECK-NEXT:  %6 = CreateFunctionInst (:object) %" 1#"(): any
// CHECK-NEXT:  %7 = StoreGetterSetterInst undefined: undefined, %6: object, %2: object, "y": string, true: boolean
// CHECK-NEXT:  %8 = CreateFunctionInst (:object) %" 2#"(): any
// CHECK-NEXT:  %9 = StoreOwnPropertyInst %8: object, %2: object, "z": string, true: boolean
