...
// CHECK-NEXT:        CondBranchInst %16: any, %BB4, %BB2
// CHECK-NEXT:%BB1:
// CHECK-NEXT:  %18 = LoadStackInst (:any) %9: any
// CHECK-NEXT:        CondBranchInst %18: any, %BB10, %BB9
// CHECK-NEXT:%BB2:
...
// CHECK-NEXT:        CondBranchInst %15: any, %BB26, %BB25
// CHECK-NEXT:%BB2:
...
// CHECK-NEXT:        CondBranchInst %20: any, %BB4, %BB3
// CHECK-NEXT:%BB3:
...
// CHECK-NEXT:        CondBranchInst %32: any, %BB4, %BB2
// CHECK-NEXT:%BB7:
// CHECK-NEXT:        BranchInst %BB8
// CHECK-NEXT:%BB8:
// CHECK-NEXT:        TryEndInst
...
// CHECK-NEXT:        CondBranchInst %26: any, %BB7, %BB5
// CHECK-NEXT:%BB4:
// CHECK-NEXT:  %28 = LoadStackInst (:any) %19: any
// CHECK-NEXT:        CondBranchInst %28: any, %BB13, %BB12
// CHECK-NEXT:%BB5:
...
// CHECK-NEXT:        CondBranchInst %33: any, %BB7, %BB6
// CHECK-NEXT:%BB6:
...
// CHECK-NEXT:        CondBranchInst %16: any, %BB37, %BB36
// CHECK-NEXT:%BB2:
...
// CHECK-NEXT:        CondBranchInst %21: any, %BB4, %BB3
// CHECK-NEXT:%BB3:
...
// CHECK-NEXT:        CondBranchInst %44: any, %BB7, %BB5
// CHECK-NEXT:%BB10:
// CHECK-NEXT:        BranchInst %BB11
// CHECK-NEXT:%BB11:
// CHECK-NEXT:        TryEndInst
...
// CHECK-NEXT:        CondBranchInst %87: any, %BB26, %BB25
// CHECK-NEXT:%BB25:
...
// CHECK-NEXT:        CondBranchInst %96: any, %BB32, %BB31
// CHECK-NEXT:%BB29:
