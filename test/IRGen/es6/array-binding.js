...
// CHECK-NEXT:        CondBranchInst %29: any, %BB9, %BB10
// CHECK-NEXT:%BB10:
...
// CHECK-NEXT:        CondBranchInst %49: any, %BB17, %BB18
// CHECK-NEXT:%BB18:
...
// CHECK-NEXT:        CondBranchInst %55: any, %BB19, %BB17
// CHECK-NEXT:%BB17:
...
// CHECK-NEXT:        CondBranchInst %65: any, %BB23, %BB24
// CHECK-NEXT:%BB21:
...
// CHECK-NEXT:        TryStartInst %BB25, %BB26
// CHECK-NEXT:%BB27:
// CHECK-NEXT:  %78 = LoadStackInst (:any) %73: any
// CHECK-NEXT:        CondBranchInst %78: any, %BB28, %BB29
// CHECK-NEXT:%BB25:
...
// CHECK-NEXT:        CondBranchInst %91: any, %BB33, %BB34
// CHECK-NEXT:%BB34:
...
// CHECK-NEXT:        CondBranchInst %97: any, %BB36, %BB33
// CHECK-NEXT:%BB33:
// CHECK-NEXT:        StoreStackInst 1: number, %75: any
// CHECK-NEXT:         BranchInst %BB36
// CHECK-NEXT:%BB36:
// CHECK-NEXT:         TryStartInst %BB37, %BB38
// CHECK-NEXT:%BB37:
...
// CHECK-NEXT:         CondBranchInst %116: any, %BB40, %BB43
// CHECK-NEXT:%BB43:
// CHECK-NEXT:         StoreStackInst %114: any, %75: any
// CHECK-NEXT:         BranchInst %BB40
// CHECK-NEXT:%BB40:
// CHECK-NEXT:         TryStartInst %BB44, %BB45
// CHECK-NEXT:%BB44:
