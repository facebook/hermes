...
// CHECK-NEXT:  %5 = StorePropertyLooseInst %4: object, globalObject: object, "testAnd": string
// CHECK-NEXT:  %6 = CreateFunctionInst (:object) %testOr(): any
// CHECK-NEXT:  %7 = StorePropertyLooseInst %6: object, globalObject: object, "testOr": string
// CHECK-NEXT:  %8 = CreateFunctionInst (:object) %testNullish(): any
// CHECK-NEXT:  %9 = StorePropertyLooseInst %8: object, globalObject: object, "testNullish": string
// CHECK-NEXT:  %10 = CreateFunctionInst (:object) %testComplex(): any
// CHECK-NEXT:  %11 = StorePropertyLooseInst %10: object, globalObject: object, "testComplex": string
