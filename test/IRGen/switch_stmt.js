...
// CHECK-NEXT:%BB1:
// CHECK-NEXT:  %4 = ReturnInst (:any) "invalid": string
// CHECK-NEXT:%BB2:
// CHECK-NEXT:  %5 = ReturnInst (:any) 0: number
// CHECK-NEXT:%BB4:
...
// CHECK-NEXT:  %8 = BranchInst %BB1
// CHECK-NEXT:%BB1:
// CHECK-NEXT:  %9 = ReturnInst (:any) "invalid": string
// CHECK-NEXT:%BB7:
