...
// CHECK-NEXT:  %5 = StorePropertyLooseInst %4: object, globalObject: object, "foo": string
// CHECK-NEXT:  %6 = CreateFunctionInst (:object) %assignment_test(): any
// CHECK-NEXT:  %7 = StorePropertyLooseInst %6: object, globalObject: object, "assignment_test": string
// CHECK-NEXT:  %8 = CreateFunctionInst (:object) %member_test(): any
// CHECK-NEXT:  %9 = StorePropertyLooseInst %8: object, globalObject: object, "member_test": string
// CHECK-NEXT:  %10 = CreateFunctionInst (:object) %binary_ops(): any
// CHECK-NEXT:  %11 = StorePropertyLooseInst %10: object, globalObject: object, "binary_ops": string
