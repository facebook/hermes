...
// CHECK-NEXT:  %3 = StorePropertyInst %2 : closure, globalObject : object, "assignment_test" : string
// CHECK-NEXT:  %4 = CreateFunctionInst %member_test()
// CHECK-NEXT:  %5 = StorePropertyInst %4 : closure, globalObject : object, "member_test" : string
// CHECK-NEXT:  %6 = CreateFunctionInst %binary_ops()
// CHECK-NEXT:  %7 = StorePropertyInst %6 : closure, globalObject : object, "binary_ops" : string
...
// CHECK-NEXT:  %50 = StorePropertyInst %49, %48, "t" : string
...
// CHECK-NEXT:  %55 = StorePropertyInst %54, %51, "t" : string
...
// CHECK-NEXT:  %60 = StorePropertyInst %59, %56, "t" : string
...
// CHECK-NEXT:  %65 = StorePropertyInst %64, %61, "t" : string
...
// CHECK-NEXT:  %70 = StorePropertyInst %69, %66, "t" : string
...
// CHECK-NEXT:  %75 = StorePropertyInst %74, %71, "t" : string
...
// CHECK-NEXT:  %80 = StorePropertyInst %79, %76, "t" : string
...
// CHECK-NEXT:  %85 = StorePropertyInst %84, %81, "t" : string
...
// CHECK-NEXT:  %90 = StorePropertyInst %89, %86, "t" : string
...
// CHECK-NEXT:  %95 = StorePropertyInst %94, %91, "t" : string
...
// CHECK-NEXT:  %100 = StorePropertyInst %99, %96, "t" : string
...
// CHECK-NEXT:  %105 = StorePropertyInst %104, %101, "t" : string
