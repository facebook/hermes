...
// CHECK-NEXT:  %5 = StorePropertyLooseInst %4: object, globalObject: object, "logical_and": string
// CHECK-NEXT:  %6 = CreateFunctionInst (:object) %logical_or(): any
// CHECK-NEXT:  %7 = StorePropertyLooseInst %6: object, globalObject: object, "logical_or": string
// CHECK-NEXT:  %8 = CreateFunctionInst (:object) %logical_and_and(): any
// CHECK-NEXT:  %9 = StorePropertyLooseInst %8: object, globalObject: object, "logical_and_and": string
// CHECK-NEXT:  %10 = CreateFunctionInst (:object) %logical_and_or(): any
// CHECK-NEXT:  %11 = StorePropertyLooseInst %10: object, globalObject: object, "logical_and_or": string
