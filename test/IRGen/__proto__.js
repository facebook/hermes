...
// CHECK-NEXT:  %6 = StorePropertyLooseInst %5: object, globalObject: object, "protoIsFirst": string
// CHECK-NEXT:  %7 = CreateFunctionInst (:object) %protoIsConst1(): any
// CHECK-NEXT:  %8 = StorePropertyLooseInst %7: object, globalObject: object, "protoIsConst1": string
// CHECK-NEXT:  %9 = CreateFunctionInst (:object) %protoIsConst2(): any
// CHECK-NEXT:  %10 = StorePropertyLooseInst %9: object, globalObject: object, "protoIsConst2": string
// CHECK-NEXT:  %11 = CreateFunctionInst (:object) %protoIsConst3(): any
// CHECK-NEXT:  %12 = StorePropertyLooseInst %11: object, globalObject: object, "protoIsConst3": string
// CHECK-NEXT:  %13 = CreateFunctionInst (:object) %protoIsDynamic(): any
// CHECK-NEXT:  %14 = StorePropertyLooseInst %13: object, globalObject: object, "protoIsDynamic": string
