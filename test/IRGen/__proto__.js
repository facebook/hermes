...
// CHECK-NEXT:       DefineOwnPropertyInst 2: number, %6: object, "a": string, true: boolean
// CHECK-NEXT:       DefineOwnPropertyInst 3: number, %6: object, "b": string, true: boolean
...
// CHECK-NEXT:       DefineOwnPropertyInst 2: number, %2: object, "a": string, true: boolean
...
// CHECK-NEXT:       DefineOwnPropertyInst 3: number, %2: object, "b": string, true: boolean
// CHECK-NEXT:       ReturnInst %2: object
// CHECK-NEXT:function_end
...
// CHECK-NEXT:  %2 = AllocObjectLiteralInst (:object) null: null
// CHECK-NEXT:       DefineOwnPropertyInst 4: number, %2: object, "c": string, true: boolean
// CHECK-NEXT:       ReturnInst %2: object
// CHECK-NEXT:function_end
...
// CHECK-NEXT:       DefineOwnPropertyInst %8: any, %6: object, "a": string, true: boolean
// CHECK-NEXT:        DefineOwnPropertyInst 10: number, %6: object, "b": string, true: boolean
