...
// CHECK-NEXT:  %7 = CreateFunctionInst (:object) %simple_try_catch_test(): any
// CHECK-NEXT:  %8 = StorePropertyLooseInst %7: object, globalObject: object, "simple_try_catch_test": string
// CHECK-NEXT:  %9 = CreateFunctionInst (:object) %simple_try_catch_finally_test(): any
// CHECK-NEXT:  %10 = StorePropertyLooseInst %9: object, globalObject: object, "simple_try_catch_finally_test": string
// CHECK-NEXT:  %11 = CreateFunctionInst (:object) %simple_try_finally_test(): any
// CHECK-NEXT:  %12 = StorePropertyLooseInst %11: object, globalObject: object, "simple_try_finally_test": string
// CHECK-NEXT:  %13 = CreateFunctionInst (:object) %try_catch_finally_with_return_test(): any
// CHECK-NEXT:  %14 = StorePropertyLooseInst %13: object, globalObject: object, "try_catch_finally_with_return_test": string
// CHECK-NEXT:  %15 = CreateFunctionInst (:object) %nested_try_test(): any
// CHECK-NEXT:  %16 = StorePropertyLooseInst %15: object, globalObject: object, "nested_try_test": string
// CHECK-NEXT:  %17 = CreateFunctionInst (:object) %nested_catch_test(): any
// CHECK-NEXT:  %18 = StorePropertyLooseInst %17: object, globalObject: object, "nested_catch_test": string
// CHECK-NEXT:  %19 = CreateFunctionInst (:object) %finally_with_break_continue_test(): any
// CHECK-NEXT:  %20 = StorePropertyLooseInst %19: object, globalObject: object, "finally_with_break_continue_test": string
