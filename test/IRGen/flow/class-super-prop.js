...
// RUN: %shermes -fno-std-globals -Werror -typed -dump-ir -O0 %s | %FileCheckOrRegen --match-full-lines %s
...
// CHECK-NEXT:  %13 = CreateFunctionInst (:object) %1: environment, %VS1: any, %B(): functionCode
...
// CHECK-NEXT:  %16 = CreateFunctionInst (:object) %1: environment, %VS1: any, %f(): functionCode
// CHECK-NEXT:  %17 = AllocTypedNonEnumObjectInst (:object) %15: object, "f": string, %16: object
