...
// CHECK-NEXT:frame = [exports: any, A: any, B: any, C0: any, C1: any, f: any, <fieldInitFuncVar:A>: object, ?A.prototype: object, <fieldInitFuncVar:B>: object, ?B.prototype: object, <fieldInitFuncVar:C0>: object, ?C0.prototype: object, <fieldInitFuncVar:C1>: object, ?C1.prototype: object]
// CHECK-NEXT:%BB0:
...
// CHECK-NEXT:       StoreFrameInst %1: environment, undefined: undefined, [C0]: any
// CHECK-NEXT:       StoreFrameInst %1: environment, undefined: undefined, [C1]: any
// CHECK-NEXT:  %8 = CreateFunctionInst (:object) %1: environment, %f(): functionCode
// CHECK-NEXT:       StoreFrameInst %1: environment, %8: object, [f]: any
// CHECK-NEXT:  %10 = CreateFunctionInst (:object) %1: environment, %<instance_members_initializer:A>(): functionCode
// CHECK-NEXT:        StoreFrameInst %1: environment, %10: object, [<fieldInitFuncVar:A>]: object
// CHECK-NEXT:  %12 = CreateFunctionInst (:object) %1: environment, %A(): functionCode
// CHECK-NEXT:        StoreFrameInst %1: environment, %12: object, [A]: any
// CHECK-NEXT:  %14 = AllocObjectInst (:object) 0: number, empty: any
// CHECK-NEXT:        StoreFrameInst %1: environment, %14: object, [?A.prototype]: object
...
// CHECK-NEXT:        StoreFrameInst %1: environment, %17: object, [<fieldInitFuncVar:B>]: object
// CHECK-NEXT:  %19 = CreateFunctionInst (:object) %1: environment, %B(): functionCode
// CHECK-NEXT:        StoreFrameInst %1: environment, %19: object, [B]: any
// CHECK-NEXT:  %21 = AllocObjectInst (:object) 0: number, empty: any
// CHECK-NEXT:        StoreFrameInst %1: environment, %21: object, [?B.prototype]: object
...
// CHECK-NEXT:        StoreFrameInst %1: environment, %24: object, [<fieldInitFuncVar:C0>]: object
// CHECK-NEXT:  %26 = CreateFunctionInst (:object) %1: environment, %C0(): functionCode
// CHECK-NEXT:        StoreFrameInst %1: environment, %26: object, [C0]: any
...
// CHECK-NEXT:        StoreFrameInst %1: environment, %29: object, [?C0.prototype]: object
// CHECK-NEXT:        StorePropertyStrictInst %29: object, %26: object, "prototype": string
// CHECK-NEXT:  %32 = LoadFrameInst (:any) %1: environment, [C0]: any
...
// CHECK-NEXT:        StoreFrameInst %1: environment, %34: object, [<fieldInitFuncVar:C1>]: object
// CHECK-NEXT:  %36 = CreateFunctionInst (:object) %1: environment, %C1(): functionCode
// CHECK-NEXT:        StoreFrameInst %1: environment, %36: object, [C1]: any
// CHECK-NEXT:  %38 = LoadFrameInst (:object) %1: environment, [?C0.prototype]: object
...
// CHECK-NEXT:        StoreFrameInst %1: environment, %40: object, [?C1.prototype]: object
// CHECK-NEXT:        StorePropertyStrictInst %40: object, %36: object, "prototype": string
// CHECK-NEXT:        ReturnInst undefined: undefined
// CHECK-NEXT:function_end

// CHECK:function f(i: number): any [typed]
// CHECK-NEXT:frame = [i: any, A: any, a: any, <fieldInitFuncVar:A>: object, ?A.prototype: object]
// CHECK-NEXT:%BB0:
...
// CHECK-NEXT:       StoreFrameInst %1: environment, %2: number, [i]: any
// CHECK-NEXT:       StoreFrameInst %1: environment, undefined: undefined, [A]: any
// CHECK-NEXT:       StoreFrameInst %1: environment, undefined: undefined, [a]: any
// CHECK-NEXT:  %6 = CreateFunctionInst (:object) %1: environment, %"<instance_members_initializer:A> 1#"(): functionCode
// CHECK-NEXT:       StoreFrameInst %1: environment, %6: object, [<fieldInitFuncVar:A>]: object
// CHECK-NEXT:  %8 = CreateFunctionInst (:object) %1: environment, %"A 1#"(): functionCode
// CHECK-NEXT:       StoreFrameInst %1: environment, %8: object, [A]: any
// CHECK-NEXT:  %10 = AllocObjectInst (:object) 0: number, empty: any
// CHECK-NEXT:        StoreFrameInst %1: environment, %10: object, [?A.prototype]: object
...
// CHECK-NEXT:        StoreFrameInst %1: environment, %17: object, [a]: any
// CHECK-NEXT:  %21 = LoadFrameInst (:any) %1: environment, [a]: any
...
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %<instance_members_initializer:A>(): any, %1: environment
...
// CHECK-NEXT:  %4 = LoadFrameInst (:object) %3: environment, [<fieldInitFuncVar:A>@""]: object
...
// CHECK-NEXT:  %0 = LoadParamInst (:any) %<this>: any
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %""(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %<instance_members_initializer:B>(): any, %1: environment
...
// CHECK-NEXT:  %3 = ResolveScopeInst (:environment) %""(): any, %2: environment
// CHECK-NEXT:  %4 = LoadFrameInst (:object) %3: environment, [<fieldInitFuncVar:B>@""]: object
...
// CHECK-NEXT:  %0 = LoadParamInst (:any) %<this>: any
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %""(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %<instance_members_initializer:C0>(): any, %1: environment
...
// CHECK-NEXT:  %0 = LoadParamInst (:any) %<this>: any
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %""(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %C0(): any, %1: environment
// CHECK-NEXT:  %3 = ResolveScopeInst (:environment) %""(): any, %2: environment
// CHECK-NEXT:  %4 = LoadFrameInst (:object) %3: environment, [<fieldInitFuncVar:C0>@""]: object
...
// CHECK-NEXT:  %0 = LoadParamInst (:object) %<this>: object
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %""(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %m(): any, %1: environment
...
// CHECK-NEXT:  %0 = LoadParamInst (:any) %<this>: any
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %""(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %<instance_members_initializer:C1>(): any, %1: environment
// CHECK-NEXT:  %3 = ResolveScopeInst (:environment) %""(): any, %2: environment
// CHECK-NEXT:  %4 = LoadFrameInst (:object) %3: environment, [?C0.prototype@""]: object
...
// CHECK-NEXT:  %0 = LoadParamInst (:object) %<this>: object
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %""(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %C1(): any, %1: environment
// CHECK-NEXT:  %3 = ResolveScopeInst (:environment) %""(): any, %2: environment
// CHECK-NEXT:  %4 = LoadFrameInst (:any) %3: environment, [C0@""]: any
...
// CHECK-NEXT:  %8 = ResolveScopeInst (:environment) %""(): any, %2: environment
// CHECK-NEXT:  %9 = LoadFrameInst (:object) %8: environment, [<fieldInitFuncVar:C1>@""]: object
...
// CHECK-NEXT:%BB0:
// CHECK-NEXT:  %0 = LoadParamInst (:any) %<this>: any
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %f(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %"<instance_members_initializer:A> 1#"(): any, %1: environment
// CHECK-NEXT:  %3 = ResolveScopeInst (:environment) %f(): any, %2: environment
// CHECK-NEXT:  %4 = LoadFrameInst (:any) %3: environment, [i@f]: any
// CHECK-NEXT:  %5 = CheckedTypeCastInst (:number) %4: any, type(number)
...
// CHECK-NEXT:  %0 = LoadParamInst (:object) %<this>: object
// CHECK-NEXT:  %1 = GetParentScopeInst (:environment) %f(): any, %parentScope: environment
// CHECK-NEXT:  %2 = CreateScopeInst (:environment) %"A 1#"(): any, %1: environment
// CHECK-NEXT:  %3 = ResolveScopeInst (:environment) %f(): any, %2: environment
// CHECK-NEXT:  %4 = LoadFrameInst (:object) %3: environment, [<fieldInitFuncVar:A>@f]: object
