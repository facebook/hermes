...
// CHECK-NEXT:  %6 = LoadFrameInst (:any) %1: environment, [%VS1.a]: any
// CHECK-NEXT:; <stdin>:11:13
// CHECK-NEXT:  %7 = LoadFrameInst (:any) %1: environment, [%VS1.b]: any
// CHECK-NEXT:; <stdin>:11:9
...
// CHECK-NEXT:; <stdin>:12:11
// CHECK-NEXT:        StoreFrameInst %1: environment, %12: any, [%VS1.a]: any
// CHECK-NEXT:; <stdin>:13:9
// CHECK-NEXT:  %14 = TryLoadGlobalPropertyInst (:any) globalObject: object, "print": string
// CHECK-NEXT:; <stdin>:13:15
// CHECK-NEXT:  %15 = LoadFrameInst (:any) %1: environment, [%VS1.a]: any
// CHECK-NEXT:; <stdin>:13:14
// CHECK-NEXT:  %16 = CallInst (:any) %14: any, empty: any, false: boolean, empty: any, undefined: undefined, undefined: undefined, %15: any
// CHECK-NEXT:; <stdin>:11:5
// CHECK-NEXT:        BranchInst %BB3
// CHECK-NEXT:%BB2:
// CHECK-NEXT:; <stdin>:15:9
// CHECK-NEXT:  %18 = LoadFrameInst (:any) %1: environment, [%VS1.b]: any
// CHECK-NEXT:; <stdin>:15:14
// CHECK-NEXT:  %19 = LoadFrameInst (:any) %1: environment, [%VS1.a]: any
// CHECK-NEXT:; <stdin>:15:11
// CHECK-NEXT:  %20 = BinarySubtractInst (:any) %18: any, %19: any
// CHECK-NEXT:; <stdin>:15:11
// CHECK-NEXT:        StoreFrameInst %1: environment, %20: any, [%VS1.b]: any
// CHECK-NEXT:; <stdin>:16:9
// CHECK-NEXT:  %22 = TryLoadGlobalPropertyInst (:any) globalObject: object, "print": string
// CHECK-NEXT:; <stdin>:16:15
// CHECK-NEXT:  %23 = LoadFrameInst (:any) %1: environment, [%VS1.b]: any
// CHECK-NEXT:; <stdin>:16:14
// CHECK-NEXT:  %24 = CallInst (:any) %22: any, empty: any, false: boolean, empty: any, undefined: undefined, undefined: undefined, %23: any
// CHECK-NEXT:; <stdin>:11:5
// CHECK-NEXT:        BranchInst %BB3
// CHECK-NEXT:%BB3:
// CHECK-NEXT:; <stdin>:18:1
