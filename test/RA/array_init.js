// RUN: %hermes -O -dump-ra %s | %FileCheck %s --match-full-lines
...
//CHECK-NEXT:  $Reg2 @7 [empty]	%7 = StoreOwnPropertyInst %5, %6 : object, 0 : number
//CHECK-NEXT:  $Reg2 @8 [empty]	%8 = StoreOwnPropertyInst %3 : number, %6 : object, 1 : number
//CHECK-NEXT:  $Reg2 @9 [10...11) 	%9 = LoadPropertyInst %1 : object, "t" : string
//CHECK-NEXT:  $Reg2 @10 [11...12) 	%10 = BinaryOperatorInst '+', %9, %3 : number
//CHECK-NEXT:  $Reg2 @11 [empty]	%11 = StoreOwnPropertyInst %10 : string|number, %6 : object, 2 : number
//CHECK-NEXT:  $Reg2 @12 [13...14) 	%12 = HBCLoadConstInst 2 : number
//CHECK-NEXT:  $Reg2 @13 [empty]	%13 = StoreOwnPropertyInst %12 : number, %6 : object, 3 : number
...
//CHECK-NEXT:  $Reg2 @17 [empty]	%17 = StoreOwnPropertyInst %16 : string|number, %6 : object, 4 : number
...
//CHECK-NEXT:  $Reg3 @21 [empty]	%21 = StoreOwnPropertyInst %20 : string, %19 : object, 3 : number
...
//CHECK-NEXT:  $Reg3 @24 [empty]	%24 = StoreOwnPropertyInst %20 : string, %23 : object, 5 : number
...
//CHECK-NEXT:  $Reg3 @28 [empty]	%28 = StoreOwnPropertyInst %26, %27 : object, 2 : number
//CHECK-NEXT:  $Reg3 @29 [30...31) 	%29 = LoadPropertyInst %1 : object, "t" : string
//CHECK-NEXT:  $Reg3 @30 [31...32) 	%30 = BinaryOperatorInst '+', %29, %3 : number
//CHECK-NEXT:  $Reg3 @31 [empty]	%31 = StoreOwnPropertyInst %30 : string|number, %27 : object, 3 : number
//CHECK-NEXT:  $Reg2 @32 [empty]	%32 = StoreOwnPropertyInst %20 : string, %27 : object, 6 : number
