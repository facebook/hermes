...
// CHECK-NEXT:  $Reg0 @2 [empty]	%2 = StorePropertyLooseInst %0 : object, %1 : object, "const_array" : string
// CHECK-NEXT:  $Reg4 @3 [4...31) 	%3 = HBCLoadConstInst 1 : number
// CHECK-NEXT:  $Reg0 @4 [empty]	%4 = StorePropertyLooseInst %3 : number, %1 : object, "t" : string
...
// CHECK-NEXT:  $Reg0 @18 [empty]	%18 = StorePropertyLooseInst %6 : object, %1 : object, "exp_array" : string
...
// CHECK-NEXT:  $Reg0 @22 [empty]	%22 = StorePropertyLooseInst %19 : object, %1 : object, "elision_array" : string
...
// CHECK-NEXT:  $Reg0 @25 [empty]	%25 = StorePropertyLooseInst %23 : object, %1 : object, "const_then_elision_array" : string
...
// CHECK-NEXT:  $Reg0 @33 [empty]	%33 = StorePropertyLooseInst %27 : object, %1 : object, "exp_then_elision_array" : string
