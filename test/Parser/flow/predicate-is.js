...
declare function foo(x: mixed): x is number;
// CHECK-NEXT:     {
...
async (x: mixed): x is number => true;
// CHECK-NEXT:     {
// CHECK-NEXT:       "type": "ExpressionStatement",
// CHECK-NEXT:       "expression": {
// CHECK-NEXT:         "type": "ArrowFunctionExpression",
...
class C { m(): x is D { return x !== null } }
// CHECK-NEXT:     {
...
class C { m(): this is D { return x !== null } }
// CHECK-NEXT:     {
// CHECK-NEXT:       "type": "ClassDeclaration",
// CHECK-NEXT:       "id": {
// CHECK-NEXT:         "type": "Identifier",
