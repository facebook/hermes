...
// CHECK-NEXT:%class_constructor.4 = class_constructor(%class.9)
// CHECK-NEXT:%union.5 = union(null | %class.9)
// CHECK-NEXT:%function.6 = function(this: %class.2): void
// CHECK-NEXT:%function.7 = function(this: %class.9, root: %class.2, val: number): void
// CHECK-NEXT:%class.8 = class( {
// CHECK-NEXT:})
// CHECK-NEXT:%class.9 = class(BBB {
