...
// CHECK-NEXT:%class_constructor.5 = class_constructor(%class.9)
// CHECK-NEXT:%function.6 = function(this: %class.9, a: %class.2): any
// CHECK-NEXT:%object.7 = object({
// CHECK-NEXT:})
// CHECK-NEXT:%class.8 = class( {
// CHECK-NEXT:  #y [final]: %function.4
// CHECK-NEXT:  foo [final]: %untyped_function.1
// CHECK-NEXT:})
// CHECK-NEXT:%class.9 = class(B {
