...
// CHECK-NEXT:%function.4 = function(this: %class.2): void
// CHECK-NEXT:%function.5 = function(this: %class.2, x: number): number
// CHECK-NEXT:%function.6 = function(this: %class.2, x: string): string
// CHECK-NEXT:%function.7 = function(this: %class.2, x: number, y: string): number
...
// CHECK-NEXT:                    Id 'Box' [D:E:%d.2 'Box'] : %class_constructor.3
