...
// CHECK-NEXT:            Decl %d.1 'f' ScopedFunction : function %t.2
// CHECK-NEXT:            Decl %d.2 'arguments' Var Arguments
// CHECK-NEXT:            hoistedFunction f
// CHECK-NEXT:        Func strict
// CHECK-NEXT:            Scope %s.3
// CHECK-NEXT:                Decl %d.3 'x' Parameter : any
// CHECK-NEXT:                Decl %d.4 'n' Parameter : number
...
// CHECK-NEXT:                                    Id 'n' [D:E:%d.4 'n'] : number
// CHECK-NEXT:                                Id 'x' [D:E:%d.3 'x'] : any
// CHECK-NEXT:                        ExpressionStatement
// CHECK-NEXT:                            AssignmentExpression : any
// CHECK-NEXT:                                ImplicitCheckedCast : number
// CHECK-NEXT:                                    Id 'n' [D:E:%d.4 'n'] : number
