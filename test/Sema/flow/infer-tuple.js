...
// CHECK-NEXT:%tuple.2 = tuple(number, %union.7)
// CHECK-NEXT:%tuple.3 = tuple(number, boolean)
// CHECK-NEXT:%tuple.4 = tuple(%tuple.3, string)
// CHECK-NEXT:%function.5 = function(): %tuple.3
// CHECK-NEXT:%object.6 = object({
// CHECK-NEXT:})
// CHECK-NEXT:%union.7 = union(boolean | string)
...
// CHECK-NEXT:            Decl %d.3 'b' Let : %tuple.3
// CHECK-NEXT:            Decl %d.4 'c' Let : %tuple.3
// CHECK-NEXT:            Decl %d.5 'd' Var : %function.5
