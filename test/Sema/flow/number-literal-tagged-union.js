...
// Flow/TS-style discriminated unions: objects with a number-literal-typed tag.
type Circle = {tag: 1, radius: number};
type Square = {tag: 2, side: number};
type Shape = Circle | Square;

let c: Circle = {tag: 1, radius: 1};
let s: Square = {tag: 2, side: 2};

let shape: Shape = c;

// The discriminant of a single arm has the literal type.
let cc: Circle = {tag: 1, radius: 3};
let tag: 1 = cc.tag;
