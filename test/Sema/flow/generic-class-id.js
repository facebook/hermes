...
// CHECK-NEXT:%function.4 = function(this: %class.2, val: number): void
// CHECK-NEXT:%class.5 = class(ID {
...
// CHECK-NEXT:%function.7 = function(this: %class.5, val: string): void
...
// CHECK-NEXT:            Decl %d.5 'i2' Const : %class.5
// CHECK-NEXT:            Decl %d.6 's' Const : string
// CHECK-NEXT:            Decl %d.7 'arguments' Var Arguments
// CHECK-NEXT:            Decl %d.8 'ID' Class : %class_constructor.3
// CHECK-NEXT:            Decl %d.9 'ID' Class : %class_constructor.6
...
// CHECK-NEXT:                                Id 'ID' [D:E:%d.8 'ID'] : %class_constructor.3
...
// CHECK-NEXT:                        VariableDeclarator
// CHECK-NEXT:                            MemberExpression : string
// CHECK-NEXT:                                Id 'i2' [D:E:%d.5 'i2'] : %class.5
// CHECK-NEXT:                                Id 'val'
