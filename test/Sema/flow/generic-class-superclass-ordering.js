...
// CHECK-NEXT:%class_constructor.2 = class_constructor(%class.16)
...
// CHECK-NEXT:%function.5 = function(this: %class.16, val: %class.3): void
...
// CHECK-NEXT:})
// CHECK-NEXT:%class.19 = class( extends %class.18 {
// CHECK-NEXT:})
