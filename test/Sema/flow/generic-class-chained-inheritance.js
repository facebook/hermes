...
// CHECK-NEXT:%class_constructor.2 = class_constructor(%class.10)
// CHECK-NEXT:%class.3 = class(B extends %class.10 {
// CHECK-NEXT:  %constructor: %function.6
// CHECK-NEXT:  %homeObject: %class.11
// CHECK-NEXT:  x: number
// CHECK-NEXT:})
// CHECK-NEXT:%class_constructor.4 = class_constructor(%class.3)
// CHECK-NEXT:%function.5 = function(this: %class.10, val: %class.3): void
// CHECK-NEXT:%function.6 = function(this: %class.3): void
// CHECK-NEXT:%class_constructor.7 = class_constructor(%class.12)
// CHECK-NEXT:%function.8 = function(this: %class.12): void
// CHECK-NEXT:%union.9 = union(null | %class.12)
// CHECK-NEXT:%class.10 = class(A {
// CHECK-NEXT:  %homeObject: %class.13
// CHECK-NEXT:})
// CHECK-NEXT:%class.11 = class( extends %class.13 {
// CHECK-NEXT:})
// CHECK-NEXT:%class.12 = class(C extends %class.3 {
...
// CHECK-NEXT:})
// CHECK-NEXT:%class.14 = class( extends %class.11 {
// CHECK-NEXT:})
...
// CHECK-NEXT:            Decl %d.9 'val' Parameter : %class.3
...
// CHECK-NEXT:            Id 'A' [D:E:%d.3 'A'] : %class_constructor.2
// CHECK-NEXT:            ClassBody
...
// CHECK-NEXT:            TypeParameterDeclaration
// CHECK-NEXT:                TypeParameter
// CHECK-NEXT:            Id 'B' [D:E:%d.7 'B'] : %class_constructor.4
