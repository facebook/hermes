...
// CHECK-NEXT:%class.3 = class(B extends %class.11 {
// CHECK-NEXT:  %constructor: %function.6
// CHECK-NEXT:  %homeObject: %class.12
// CHECK-NEXT:  x: number
// CHECK-NEXT:})
// CHECK-NEXT:%class_constructor.4 = class_constructor(%class.3)
// CHECK-NEXT:%function.5 = function(this: %class.11, val: %class.3): void
// CHECK-NEXT:%function.6 = function(this: %class.3): void
// CHECK-NEXT:%class_constructor.7 = class_constructor(%class.13)
// CHECK-NEXT:%function.8 = function(this: %class.13): void
// CHECK-NEXT:%union.9 = union(null | %class.13)
// CHECK-NEXT:%object.10 = object({
// CHECK-NEXT:})
// CHECK-NEXT:%class.11 = class(A {
// CHECK-NEXT:  %homeObject: %class.14
// CHECK-NEXT:})
// CHECK-NEXT:%class.12 = class( extends %class.14 {
// CHECK-NEXT:})
// CHECK-NEXT:%class.13 = class(C extends %class.3 {
...
// CHECK-NEXT:})
// CHECK-NEXT:%class.15 = class( extends %class.12 {
// CHECK-NEXT:})
