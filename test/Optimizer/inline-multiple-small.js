...
// CHECK-NEXT:  %2 = CallInst (:string|number) %1: object, %f3(): functionCode, false: boolean, empty: any, undefined: undefined, 0: number, 10: number
// CHECK-NEXT:  %3 = BinaryAddInst (:string|number) 1734: number, %2: string|number
// CHECK-NEXT:  %4 = CallInst (:string|number) %1: object, %f3(): functionCode, false: boolean, empty: any, undefined: undefined, 0: number, 100: number
