...
// CHECK-NEXT:frame = [O: object, Foo: undefined|object, ?O.prototype: object, ?Foo.prototype: object]
// CHECK-NEXT:%BB0:
// CHECK-NEXT:  %0 = GetParentScopeInst (:environment) %global(): any, %parentScope: environment
// CHECK-NEXT:  %1 = CreateScopeInst (:environment) %""(): any, %0: environment
// CHECK-NEXT:       StoreFrameInst %1: environment, undefined: undefined, [Foo]: undefined|object
...
// CHECK-NEXT:       StoreFrameInst %1: environment, %4: object, [O]: object
// CHECK-NEXT:  %6 = AllocObjectInst (:object) 0: number, empty: any
// CHECK-NEXT:       StoreFrameInst %1: environment, %6: object, [?O.prototype]: object
...
// CHECK-NEXT:        StoreFrameInst %1: environment, %9: object, [Foo]: undefined|object
// CHECK-NEXT:  %11 = AllocObjectInst (:object) 0: number, empty: any
// CHECK-NEXT:        StoreFrameInst %1: environment, %11: object, [?Foo.prototype]: object
...
// CHECK-NEXT:  %1 = LoadFrameInst (:undefined|object) %0: environment, [Foo@""]: undefined|object
// CHECK-NEXT:  %2 = CheckedTypeCastInst (:object) %1: undefined|object, type(object)
// CHECK-NEXT:  %3 = LoadFrameInst (:object) %0: environment, [?Foo.prototype@""]: object
// CHECK-NEXT:  %4 = AllocObjectLiteralInst (:object) "o": string, 0: number, "y": string, 0: number
...
// CHECK-NEXT:  %5 = LoadFrameInst (:object) %1: environment, [O@""]: object
// CHECK-NEXT:  %6 = LoadFrameInst (:object) %1: environment, [?O.prototype@""]: object
// CHECK-NEXT:  %7 = AllocObjectLiteralInst (:object) "i": string, 0: number
