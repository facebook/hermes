...
// CHECK-NEXT:  %2 = CreateFunctionInst (:object) %0: environment, %VS0: any, %outer1(): functionCode
...
// CHECK-NEXT:  %1 = CreateFunctionInst (:object) %0: environment, %VS0: any, %dontInline(): functionCode
// CHECK-NEXT:  %2 = CallInst (:any) %1: object, %dontInline(): functionCode, true: boolean, empty: any, undefined: undefined, undefined: undefined, 1: number
