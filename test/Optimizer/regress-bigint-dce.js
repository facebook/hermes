...
// CHECK-NEXT:  %9 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f1_throws(): functionCode
// CHECK-NEXT:        StorePropertyLooseInst %9: object, globalObject: object, "f1_throws": string
// CHECK-NEXT:  %11 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f2_throws(): functionCode
// CHECK-NEXT:        StorePropertyLooseInst %11: object, globalObject: object, "f2_throws": string
// CHECK-NEXT:  %13 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f3_ok(): functionCode
// CHECK-NEXT:        StorePropertyLooseInst %13: object, globalObject: object, "f3_ok": string
// CHECK-NEXT:  %15 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f4_ok(): functionCode
// CHECK-NEXT:        StorePropertyLooseInst %15: object, globalObject: object, "f4_ok": string
// CHECK-NEXT:  %17 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f5_ok(): functionCode
// CHECK-NEXT:        StorePropertyLooseInst %17: object, globalObject: object, "f5_ok": string
// CHECK-NEXT:  %19 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f6_ok(): functionCode
// CHECK-NEXT:        StorePropertyLooseInst %19: object, globalObject: object, "f6_ok": string
// CHECK-NEXT:  %21 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f7_ok(): functionCode
// CHECK-NEXT:        StorePropertyLooseInst %21: object, globalObject: object, "f7_ok": string
// CHECK-NEXT:  %23 = CreateFunctionInst (:object) %0: environment, %VS0: any, %f8_ok(): functionCode
