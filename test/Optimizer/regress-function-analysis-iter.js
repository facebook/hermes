...
// CHECK-NEXT:%BB2:
// CHECK-NEXT:  %6 = CallInst (:number) %1: object, %f1(): functionCode, false: boolean, %0: environment, undefined: undefined, 0: number
// CHECK-NEXT:       BranchInst %BB1
// CHECK-NEXT:%BB3:
// CHECK-NEXT:  %8 = TryLoadGlobalPropertyInst (:any) globalObject: object, "b": string
// CHECK-NEXT:       CondBranchInst %8: any, %BB5, %BB4
// CHECK-NEXT:%BB4:
// CHECK-NEXT:  %10 = CallInst (:number) %1: object, %f1(): functionCode, false: boolean, %0: environment, undefined: undefined, 0: number
