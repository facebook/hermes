...
// CHECK-NEXT:  %2 = CreateFunctionInst (:object) empty: any, empty: any, %load_only_capture(): functionCode
// CHECK-NEXT:       StorePropertyLooseInst %2: object, globalObject: object, "load_only_capture": string
// CHECK-NEXT:  %4 = CreateFunctionInst (:object) empty: any, empty: any, %load_dedup(): functionCode
...
// CHECK-NEXT:        StoreFrameInst %0: environment, %9: number, [%VS0.i]: number
...
// CHECK-NEXT:       StoreFrameInst %0: environment, %5: any, [%VS1.x]: any
...
// CHECK-NEXT:  %2 = LoadFrameInst (:any) %0: environment, [%VS1.x]: any
