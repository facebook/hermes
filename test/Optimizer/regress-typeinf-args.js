...
// CHECK-NEXT:  %2 = CreateFunctionInst (:object) %1: environment, %"f1 1#"(): functionCode
// CHECK-NEXT:       StoreFrameInst %1: environment, %2: object, [f1]: object
// CHECK-NEXT:  %4 = CreateFunctionInst (:object) %1: environment, %"f3 1#"(): functionCode
...
// CHECK:function "f1 1#"(p1: undefined): undefined [allCallsitesKnownInStrictMode,unreachable]
// CHECK-NEXT:frame = []
// CHECK-NEXT:%BB0:
// CHECK-NEXT:       UnreachableInst
// CHECK-NEXT:function_end
