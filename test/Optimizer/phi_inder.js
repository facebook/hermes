...
// CHECK-NEXT:  %2 = CreateFunctionInst (:object) empty: any, empty: any, %sink(): functionCode
// CHECK-NEXT:       StorePropertyLooseInst %2: object, globalObject: object, "sink": string
// CHECK-NEXT:  %4 = CreateFunctionInst (:object) empty: any, empty: any, %recursive_phi(): functionCode
