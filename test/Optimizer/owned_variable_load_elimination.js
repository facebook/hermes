...
// CHECK-NEXT:       StoreFrameInst %0: environment, 0: number, [%VS1.x]: number
...
// CHECK-NEXT:       StoreFrameInst %0: environment, %6: number, [%VS1.x]: number
...
// CHECK-NEXT:%BB3:
// CHECK-NEXT:  %12 = LoadFrameInst (:number) %0: environment, [%VS1.x]: number
...
// CHECK-NEXT:%BB5:
// CHECK-NEXT:  %19 = LoadFrameInst (:number) %0: environment, [%VS1.x]: number
// CHECK-NEXT:  %20 = FAddInst (:number) %19: number, 1: number
// CHECK-NEXT:        StoreFrameInst %0: environment, %20: number, [%VS1.x]: number
...
// CHECK-NEXT:%BB6:
// CHECK-NEXT:  %24 = CreateFunctionInst (:object) %0: environment, %VS1: any, %""(): functionCode
