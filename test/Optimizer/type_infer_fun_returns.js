...
// CHECK-NEXT:  %1 = CreateFunctionInst (:object) empty: any, empty: any, %g14(): functionCode
// CHECK-NEXT:       StorePropertyLooseInst %1: object, globalObject: object, "g14": string
// CHECK-NEXT:       ReturnInst undefined: undefined
// CHECK-NEXT:function_end

// CHECK:scope %VS0 [w: object]

// CHECK:function g14(z: any): undefined|object
// CHECK-NEXT:%BB0:
// CHECK-NEXT:  %0 = CreateScopeInst (:environment) %VS0: any, empty: any
// CHECK-NEXT:  %1 = LoadParamInst (:any) %z: any
// CHECK-NEXT:  %2 = CreateFunctionInst (:object) empty: any, empty: any, %w(): functionCode
// CHECK-NEXT:       StoreFrameInst %0: environment, %2: object, [%VS0.w]: object
...
// CHECK-NEXT:  %9 = LoadFrameInst (:object) %0: environment, [%VS0.w]: object
...
// CHECK-NEXT:  %14 = CreateFunctionInst (:object) %0: environment, %VS0: any, %m(): functionCode
...
// CHECK-NEXT:  %1 = CreateFunctionInst (:object) empty: any, empty: any, %"w 1#"(): functionCode
// CHECK-NEXT:       StoreFrameInst %0: environment, %1: object, [%VS0.w]: object
// CHECK-NEXT:       ReturnInst undefined: undefined
// CHECK-NEXT:function_end
