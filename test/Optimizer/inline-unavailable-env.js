...
// CHECK:scope %VS0 [x: undefined|object, numBar: number]

// CHECK:scope %VS1 [y: number]
...
// CHECK-NEXT:  %6 = LoadFrameInst (:undefined|object) %0: environment, [%VS0.x]: undefined|object
...
// CHECK-NEXT:%BB2:
// CHECK-NEXT:  %10 = GetClosureScopeInst (:environment) %VS1: any, %x(): functionCode, %6: undefined|object
// CHECK-NEXT:  %11 = LoadFrameInst (:number) %10: environment, [%VS1.y]: number
// CHECK-NEXT:  %12 = FAddInst (:number) %11: number, 1: number
// CHECK-NEXT:        StoreFrameInst %10: environment, %12: number, [%VS1.y]: number
...
// CHECK-NEXT:  %1 = CreateScopeInst (:environment) %VS1: any, empty: any
// CHECK-NEXT:  %2 = LoadFrameInst (:number) %0: environment, [%VS0.numBar]: number
// CHECK-NEXT:  %3 = FAddInst (:number) %2: number, 1: number
// CHECK-NEXT:       StoreFrameInst %0: environment, %3: number, [%VS0.numBar]: number
// CHECK-NEXT:       StoreFrameInst %1: environment, %3: number, [%VS1.y]: number
// CHECK-NEXT:  %6 = CreateFunctionInst (:object) %1: environment, %VS1: any, %x(): functionCode
// CHECK-NEXT:       StoreFrameInst %0: environment, %6: object, [%VS0.x]: undefined|object
// CHECK-NEXT:       ReturnInst undefined: undefined
// CHECK-NEXT:function_end
