...
// CHECK:scope %VS0 [generator_state: number, idx: number, catchVal: any, exception_handler_idx: number]
...
// CHECK-NEXT:  %5 = LoadFrameInst (:number) %4: environment, [%VS0.generator_state]: number
...
// CHECK-NEXT:%BB2:
// CHECK-NEXT:        StoreFrameInst %4: environment, 1: number, [%VS0.exception_handler_idx]: number
// CHECK-NEXT:        StoreFrameInst %4: environment, 2: number, [%VS0.idx]: number
// CHECK-NEXT:        StoreStackInst 1: number, %2: number
// CHECK-NEXT:        StoreFrameInst %4: environment, 1: number, [%VS0.generator_state]: number
// CHECK-NEXT:        TryEndInst %BB22, %BB26
// CHECK-NEXT:%BB3:
// CHECK-NEXT:        StoreStackInst 3: number, %2: number
// CHECK-NEXT:        StoreFrameInst %4: environment, 3: number, [%VS0.generator_state]: number
// CHECK-NEXT:        TryEndInst %BB22, %BB24
// CHECK-NEXT:%BB4:
// CHECK-NEXT:  %19 = LoadFrameInst (:any) %4: environment, [%VS0.catchVal]: any
// CHECK-NEXT:        StoreStackInst %19: any, %3: any
// CHECK-NEXT:        StoreFrameInst %4: environment, 0: number, [%VS0.exception_handler_idx]: number
...
// CHECK-NEXT:        StoreFrameInst %4: environment, 2: number, [%VS0.generator_state]: number
// CHECK-NEXT:  %46 = LoadFrameInst (:number) %4: environment, [%VS0.idx]: number
...
// CHECK-NEXT:        StoreFrameInst %4: environment, %67: any, [%VS0.catchVal]: any
// CHECK-NEXT:  %70 = LoadFrameInst (:number) %4: environment, [%VS0.exception_handler_idx]: number
// CHECK-NEXT:        SwitchInst %70: number, %BB23, 0: number, %BB21
// CHECK-NEXT:%BB23:
// CHECK-NEXT:        StoreFrameInst %4: environment, 1: number, [%VS0.idx]: number
