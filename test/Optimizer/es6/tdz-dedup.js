...
// RUN: %hermesc -custom-opt=typeinference -custom-opt=tdzdedup -dump-ir %s | %FileCheck --match-full-lines --check-prefix=CHKOPT %s
...
//CHKOPT-LABEL:function inner(p) : undefined|null|boolean|string|number|int32|uint32|object|closure|regexp
//CHKOPT-NEXT:frame = [p]
//CHKOPT-NEXT:%BB0:
//CHKOPT-NEXT:  %0 = StoreFrameInst %p, [p]
//CHKOPT-NEXT:  %1 = LoadFrameInst [x@check_after_check]
//CHKOPT-NEXT:  %2 = ThrowIfEmptyInst %1
//CHKOPT-NEXT:  %3 = AsNumberInst %2 : undefined|null|boolean|string|number|int32|uint32|object|closure|regexp
