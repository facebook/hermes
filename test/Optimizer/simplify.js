...
// CHECK-NEXT:  %1 = StorePropertyInst %0 : closure, globalObject : object, "add_sub_num" : string
// CHECK-NEXT:  %2 = CreateFunctionInst %modulo_num() : undefined
// CHECK-NEXT:  %3 = StorePropertyInst %2 : closure, globalObject : object, "modulo_num" : string
// CHECK-NEXT:  %4 = CreateFunctionInst %logic_ops_test() : undefined
// CHECK-NEXT:  %5 = StorePropertyInst %4 : closure, globalObject : object, "logic_ops_test" : string
// CHECK-NEXT:  %6 = CreateFunctionInst %add_str() : undefined
// CHECK-NEXT:  %7 = StorePropertyInst %6 : closure, globalObject : object, "add_str" : string
// CHECK-NEXT:  %8 = CreateFunctionInst %add_empty_str() : undefined
// CHECK-NEXT:  %9 = StorePropertyInst %8 : closure, globalObject : object, "add_empty_str" : string
// CHECK-NEXT:  %10 = CreateFunctionInst %add_empty_str_simplify() : string
// CHECK-NEXT:  %11 = StorePropertyInst %10 : closure, globalObject : object, "add_empty_str_simplify" : string
// CHECK-NEXT:  %12 = CreateFunctionInst %add_null() : undefined
// CHECK-NEXT:  %13 = StorePropertyInst %12 : closure, globalObject : object, "add_null" : string
// CHECK-NEXT:  %14 = CreateFunctionInst %mul_null() : undefined
// CHECK-NEXT:  %15 = StorePropertyInst %14 : closure, globalObject : object, "mul_null" : string
// CHECK-NEXT:  %16 = CreateFunctionInst %left_shift_num() : undefined
// CHECK-NEXT:  %17 = StorePropertyInst %16 : closure, globalObject : object, "left_shift_num" : string
// CHECK-NEXT:  %18 = CreateFunctionInst %left_shift_null() : undefined
// CHECK-NEXT:  %19 = StorePropertyInst %18 : closure, globalObject : object, "left_shift_null" : string
// CHECK-NEXT:  %20 = CreateFunctionInst %left_shift_undefined() : undefined
// CHECK-NEXT:  %21 = StorePropertyInst %20 : closure, globalObject : object, "left_shift_undefined" : string
// CHECK-NEXT:  %22 = CreateFunctionInst %right_shift_num() : undefined
// CHECK-NEXT:  %23 = StorePropertyInst %22 : closure, globalObject : object, "right_shift_num" : string
// CHECK-NEXT:  %24 = CreateFunctionInst %right_shift_null() : undefined
// CHECK-NEXT:  %25 = StorePropertyInst %24 : closure, globalObject : object, "right_shift_null" : string
// CHECK-NEXT:  %26 = CreateFunctionInst %right_shift_undefined() : undefined
// CHECK-NEXT:  %27 = StorePropertyInst %26 : closure, globalObject : object, "right_shift_undefined" : string
// CHECK-NEXT:  %28 = CreateFunctionInst %right_shift_bool() : undefined
// CHECK-NEXT:  %29 = StorePropertyInst %28 : closure, globalObject : object, "right_shift_bool" : string
// CHECK-NEXT:  %30 = CreateFunctionInst %unsigned_right_shift_bool() : undefined
// CHECK-NEXT:  %31 = StorePropertyInst %30 : closure, globalObject : object, "unsigned_right_shift_bool" : string
// CHECK-NEXT:  %32 = CreateFunctionInst %unsigned_right_shift_compound_assgmt() : undefined
// CHECK-NEXT:  %33 = StorePropertyInst %32 : closure, globalObject : object, "unsigned_right_shift_compound_assgmt" : string
// CHECK-NEXT:  %34 = CreateFunctionInst %unsigned_right_shift_num() : undefined
// CHECK-NEXT:  %35 = StorePropertyInst %34 : closure, globalObject : object, "unsigned_right_shift_num" : string
// CHECK-NEXT:  %36 = CreateFunctionInst %add_undef() : undefined
// CHECK-NEXT:  %37 = StorePropertyInst %36 : closure, globalObject : object, "add_undef" : string
// CHECK-NEXT:  %38 = CreateFunctionInst %comp_num() : undefined
// CHECK-NEXT:  %39 = StorePropertyInst %38 : closure, globalObject : object, "comp_num" : string
// CHECK-NEXT:  %40 = CreateFunctionInst %equality() : undefined
// CHECK-NEXT:  %41 = StorePropertyInst %40 : closure, globalObject : object, "equality" : string
// CHECK-NEXT:  %42 = CreateFunctionInst %arith() : undefined
// CHECK-NEXT:  %43 = StorePropertyInst %42 : closure, globalObject : object, "arith" : string
// CHECK-NEXT:  %44 = CreateFunctionInst %undef_test() : undefined
// CHECK-NEXT:  %45 = StorePropertyInst %44 : closure, globalObject : object, "undef_test" : string
// CHECK-NEXT:  %46 = CreateFunctionInst %foo() : number
// CHECK-NEXT:  %47 = StorePropertyInst %46 : closure, globalObject : object, "foo" : string
// CHECK-NEXT:  %48 = CreateFunctionInst %strip_bang() : number
// CHECK-NEXT:  %49 = StorePropertyInst %48 : closure, globalObject : object, "strip_bang" : string
// CHECK-NEXT:  %50 = CreateFunctionInst %turn_unary_plus_into_as_number() : number
// CHECK-NEXT:  %51 = StorePropertyInst %50 : closure, globalObject : object, "turn_unary_plus_into_as_number" : string
// CHECK-NEXT:  %52 = CreateFunctionInst %turn_unary_plus_on_literal_into_result() : number
// CHECK-NEXT:  %53 = StorePropertyInst %52 : closure, globalObject : object, "turn_unary_plus_on_literal_into_result" : string
// CHECK-NEXT:  %54 = CreateFunctionInst %turn_bitor_into_as_int32() : number
// CHECK-NEXT:  %55 = StorePropertyInst %54 : closure, globalObject : object, "turn_bitor_into_as_int32" : string
// CHECK-NEXT:  %56 = CreateFunctionInst %unary_ops() : undefined
// CHECK-NEXT:  %57 = StorePropertyInst %56 : closure, globalObject : object, "unary_ops" : string
// CHECK-NEXT:  %58 = CreateFunctionInst %test_phi() : number
// CHECK-NEXT:  %59 = StorePropertyInst %58 : closure, globalObject : object, "test_phi" : string
// CHECK-NEXT:  %60 = CreateFunctionInst %if_inline() : number
// CHECK-NEXT:  %61 = StorePropertyInst %60 : closure, globalObject : object, "if_inline" : string
// CHECK-NEXT:  %62 = CreateFunctionInst %simplify_switch() : undefined
// CHECK-NEXT:  %63 = StorePropertyInst %62 : closure, globalObject : object, "simplify_switch" : string
// CHECK-NEXT:  %64 = CreateFunctionInst %objectCond() : number
// CHECK-NEXT:  %65 = StorePropertyInst %64 : closure, globalObject : object, "objectCond" : string
