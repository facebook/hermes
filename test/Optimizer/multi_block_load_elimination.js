...
// CHECK-NEXT:  %1 = CreateFunctionInst (:object) %0: environment, %VS0: any, %inner(): functionCode
...
// CHECK-NEXT:       StoreFrameInst %0: environment, %5: number, [%VS0.x]: number
// CHECK-NEXT:       CondBranchInst %1: any, %BB1, %BB2
// CHECK-NEXT:%BB1:
// CHECK-NEXT:  %8 = FAddInst (:number) %5: number, 1: number
// CHECK-NEXT:       StoreFrameInst %0: environment, %8: number, [%VS0.x]: number
...
// CHECK-NEXT:        StoreFrameInst %0: environment, %18: number, [%VS0.x]: number
// CHECK-NEXT:        BranchInst %BB6
// CHECK-NEXT:%BB6:
// CHECK-NEXT:  %21 = PhiInst (:number) %18: number, %BB5, %16: number, %BB4
// CHECK-NEXT:  %22 = FAddInst (:number) %21: number, 1: number
// CHECK-NEXT:        StoreFrameInst %0: environment, %22: number, [%VS0.x]: number
