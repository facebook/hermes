...
// RUN: %shermes -fno-std-globals -dump-transpiled-ast -typed -script %s | %FileCheck --match-full-lines -check-prefix SM %s
// RUN: %shermes -fno-std-globals -dump-transpiled-ast -typed %s | %FileCheck --match-full-lines -check-prefix MM %s
