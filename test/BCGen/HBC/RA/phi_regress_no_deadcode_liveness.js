...
// CHKRA-NEXT:  $Reg1 = HBCCreateFunctionInst (:object) %b(): functionCode, $Reg0
...
// CHKRA-NEXT:  $Reg3 = TryStartInst %BB4, %BB5
// CHKRA-NEXT:%BB2:
// CHKRA-NEXT:  $Reg0 = ReturnInst $Reg0
// CHKRA-NEXT:%BB3:
...
// CHKRA-NEXT:%BB5:
// CHKRA-NEXT:  $Reg3 = BranchInst %BB6
// CHKRA-NEXT:%BB6:
...
// CHKRA-NEXT:  $Reg5 = CondBranchInst $Reg3, %BB8, %BB7
// CHKRA-NEXT:%BB7:
// CHKRA-NEXT:  $Reg1 = MovInst (:any) $Reg4
// CHKRA-NEXT:  $Reg4 = BranchInst %BB8
// CHKRA-NEXT:%BB8:
// CHKRA-NEXT:  $Reg1 = PhiInst (:any) $Reg1, %BB6, $Reg1, %BB7
// CHKRA-NEXT:  $Reg1 = MovInst (:any) $Reg1
// CHKRA-NEXT:  $Reg4 = TryStartInst %BB9, %BB10
// CHKRA-NEXT:%BB9:
...
// CHKRA-NEXT:  $Reg8 = TryStartInst %BB12, %BB13
// CHKRA-NEXT:%BB11:
// CHKRA-NEXT:  $Reg5 = LoadStackInst (:undefined|boolean) $Reg5
// CHKRA-NEXT:  $Reg5 = CondBranchInst $Reg5, %BB64, %BB63
// CHKRA-NEXT:%BB12:
// CHKRA-NEXT:  $Reg6 = CatchInst (:any)
// CHKRA-NEXT:  $Reg6 = StoreStackInst $Reg6, $Reg1
// CHKRA-NEXT:  $Reg6 = BranchInst %BB11
// CHKRA-NEXT:%BB13:
// CHKRA-NEXT:  $Reg8 = BranchInst %BB14
// CHKRA-NEXT:%BB14:
...
// CHKRA-NEXT:  $Reg8 = CondBranchInst $Reg8, %BB16, %BB15
// CHKRA-NEXT:%BB15:
// CHKRA-NEXT:  $Reg7 = StoreStackInst $Reg7, $Reg6
// CHKRA-NEXT:  $Reg7 = BranchInst %BB16
// CHKRA-NEXT:%BB16:
// CHKRA-NEXT:  $Reg7 = TryStartInst %BB17, %BB18
// CHKRA-NEXT:%BB17:
// CHKRA-NEXT:  $Reg6 = CatchInst (:any)
// CHKRA-NEXT:  $Reg6 = StoreStackInst $Reg6, $Reg1
// CHKRA-NEXT:  $Reg6 = BranchInst %BB11
...
// CHKRA-NEXT:  $Reg11 = TryStartInst %BB20, %BB21
// CHKRA-NEXT:%BB19:
// CHKRA-NEXT:  $Reg8 = LoadStackInst (:undefined|boolean) $Reg8
// CHKRA-NEXT:  $Reg8 = CondBranchInst $Reg8, %BB59, %BB58
// CHKRA-NEXT:%BB20:
// CHKRA-NEXT:  $Reg9 = CatchInst (:any)
// CHKRA-NEXT:  $Reg9 = StoreStackInst $Reg9, $Reg6
// CHKRA-NEXT:  $Reg9 = BranchInst %BB19
// CHKRA-NEXT:%BB21:
// CHKRA-NEXT:  $Reg11 = BranchInst %BB22
// CHKRA-NEXT:%BB22:
...
// CHKRA-NEXT:  $Reg11 = CondBranchInst $Reg11, %BB24, %BB23
// CHKRA-NEXT:%BB23:
// CHKRA-NEXT:  $Reg10 = StoreStackInst $Reg10, $Reg9
// CHKRA-NEXT:  $Reg10 = BranchInst %BB24
// CHKRA-NEXT:%BB24:
// CHKRA-NEXT:  $Reg10 = TryStartInst %BB25, %BB26
// CHKRA-NEXT:%BB25:
// CHKRA-NEXT:  $Reg9 = CatchInst (:any)
// CHKRA-NEXT:  $Reg9 = StoreStackInst $Reg9, $Reg6
// CHKRA-NEXT:  $Reg9 = BranchInst %BB19
...
// CHKRA-NEXT:  $Reg14 = TryStartInst %BB28, %BB29
// CHKRA-NEXT:%BB27:
// CHKRA-NEXT:  $Reg11 = LoadStackInst (:undefined|boolean) $Reg11
// CHKRA-NEXT:  $Reg11 = CondBranchInst $Reg11, %BB54, %BB53
// CHKRA-NEXT:%BB28:
// CHKRA-NEXT:  $Reg12 = CatchInst (:any)
// CHKRA-NEXT:  $Reg12 = StoreStackInst $Reg12, $Reg9
// CHKRA-NEXT:  $Reg12 = BranchInst %BB27
// CHKRA-NEXT:%BB29:
// CHKRA-NEXT:  $Reg14 = BranchInst %BB30
// CHKRA-NEXT:%BB30:
...
// CHKRA-NEXT:  $Reg14 = CondBranchInst $Reg14, %BB32, %BB31
// CHKRA-NEXT:%BB31:
// CHKRA-NEXT:  $Reg13 = StoreStackInst $Reg13, $Reg12
// CHKRA-NEXT:  $Reg13 = BranchInst %BB32
// CHKRA-NEXT:%BB32:
// CHKRA-NEXT:  $Reg13 = TryStartInst %BB33, %BB34
// CHKRA-NEXT:%BB33:
// CHKRA-NEXT:  $Reg12 = CatchInst (:any)
// CHKRA-NEXT:  $Reg12 = StoreStackInst $Reg12, $Reg9
// CHKRA-NEXT:  $Reg12 = BranchInst %BB27
...
// CHKRA-NEXT:  $Reg17 = TryStartInst %BB36, %BB37
// CHKRA-NEXT:%BB35:
// CHKRA-NEXT:  $Reg14 = LoadStackInst (:undefined|boolean) $Reg14
// CHKRA-NEXT:  $Reg14 = CondBranchInst $Reg14, %BB49, %BB48
// CHKRA-NEXT:%BB36:
// CHKRA-NEXT:  $Reg15 = CatchInst (:any)
// CHKRA-NEXT:  $Reg15 = StoreStackInst $Reg15, $Reg12
// CHKRA-NEXT:  $Reg15 = BranchInst %BB35
// CHKRA-NEXT:%BB37:
// CHKRA-NEXT:  $Reg17 = BranchInst %BB38
// CHKRA-NEXT:%BB38:
...
// CHKRA-NEXT:  $Reg17 = CondBranchInst $Reg17, %BB40, %BB39
// CHKRA-NEXT:%BB39:
// CHKRA-NEXT:  $Reg16 = StoreStackInst $Reg16, $Reg15
// CHKRA-NEXT:  $Reg16 = BranchInst %BB40
// CHKRA-NEXT:%BB40:
// CHKRA-NEXT:  $Reg16 = TryStartInst %BB41, %BB42
// CHKRA-NEXT:%BB41:
// CHKRA-NEXT:  $Reg15 = CatchInst (:any)
// CHKRA-NEXT:  $Reg15 = StoreStackInst $Reg15, $Reg12
// CHKRA-NEXT:  $Reg15 = BranchInst %BB35
...
// CHKRA-NEXT:  $Reg15 = CmpBrEqualInst $Reg16, $Reg15, %BB43, %BB44
// CHKRA-NEXT:%BB43:
...
// CHKRA-NEXT:  $Reg15 = CondBranchInst $Reg15, %BB57, %BB56
// CHKRA-NEXT:%BB56:
// CHKRA-NEXT:  $Reg15 = LoadStackInst (:any) $Reg7
// CHKRA-NEXT:  $Reg15 = IteratorCloseInst (:any) $Reg15, false: boolean
// CHKRA-NEXT:  $Reg15 = BranchInst %BB57
// CHKRA-NEXT:%BB57:
// CHKRA-NEXT:  $Reg15 = BranchInst %BB60
// CHKRA-NEXT:%BB58:
// CHKRA-NEXT:  $Reg7 = LoadStackInst (:any) $Reg7
// CHKRA-NEXT:  $Reg7 = IteratorCloseInst (:any) $Reg7, true: boolean
// CHKRA-NEXT:  $Reg7 = BranchInst %BB59
// CHKRA-NEXT:%BB59:
// CHKRA-NEXT:  $Reg6 = LoadStackInst (:any) $Reg6
...
// CHKRA-NEXT:  $Reg15 = CondBranchInst $Reg15, %BB62, %BB61
// CHKRA-NEXT:%BB61:
...
// CHKRA-NEXT:  $Reg4 = BranchInst %BB64
// CHKRA-NEXT:%BB64:
// CHKRA-NEXT:  $Reg1 = LoadStackInst (:any) $Reg1
// CHKRA-NEXT:  $Reg1 = ThrowInst $Reg1
// CHKRA-NEXT:%BB65:
// CHKRA-NEXT:  $Reg15 = TryEndInst
// CHKRA-NEXT:  $Reg15 = CondBranchInst $Reg3, %BB2, %BB66
// CHKRA-NEXT:%BB66:
// CHKRA-NEXT:  $Reg15 = LoadStackInst (:any) $Reg2
// CHKRA-NEXT:  $Reg15 = IteratorCloseInst (:any) $Reg15, false: boolean
// CHKRA-NEXT:  $Reg15 = BranchInst %BB2
// CHKRA-NEXT:%BB67:
