...
// CHKRA-NEXT:%BB8:
// CHKRA-NEXT:  $Reg1 = PhiInst (:any) $Reg1, %BB5, $Reg1, %BB7
// CHKRA-NEXT:  $Reg1 = MovInst (:any) $Reg1
// CHKRA-NEXT:  $Reg4 = TryStartInst %BB9, %BB11
// CHKRA-NEXT:%BB9:
...
// CHKRA-NEXT:  $Reg8 = TryStartInst %BB13, %BB15
// CHKRA-NEXT:%BB12:
...
// CHKRA-NEXT:  $Reg8 = CondBranchInst $Reg8, %BB17, %BB16
// CHKRA-NEXT:%BB15:
// CHKRA-NEXT:  $Reg8 = TryEndInst %BB13, %BB14
// CHKRA-NEXT:%BB16:
// CHKRA-NEXT:  $Reg7 = StoreStackInst $Reg7, $Reg6
// CHKRA-NEXT:  $Reg7 = BranchInst %BB17
// CHKRA-NEXT:%BB17:
// CHKRA-NEXT:  $Reg7 = TryStartInst %BB18, %BB20
// CHKRA-NEXT:%BB18:
// CHKRA-NEXT:  $Reg6 = CatchInst (:any)
// CHKRA-NEXT:  $Reg6 = StoreStackInst $Reg6, $Reg1
// CHKRA-NEXT:  $Reg6 = BranchInst %BB12
...
// CHKRA-NEXT:  $Reg15 = CondBranchInst $Reg15, %BB63, %BB62
// CHKRA-NEXT:%BB20:
...
// CHKRA-NEXT:  $Reg11 = CondBranchInst $Reg11, %BB26, %BB25
// CHKRA-NEXT:%BB24:
// CHKRA-NEXT:  $Reg11 = TryEndInst %BB22, %BB23
// CHKRA-NEXT:%BB25:
// CHKRA-NEXT:  $Reg10 = StoreStackInst $Reg10, $Reg9
// CHKRA-NEXT:  $Reg10 = BranchInst %BB26
// CHKRA-NEXT:%BB26:
// CHKRA-NEXT:  $Reg10 = TryStartInst %BB27, %BB29
// CHKRA-NEXT:%BB27:
// CHKRA-NEXT:  $Reg9 = CatchInst (:any)
// CHKRA-NEXT:  $Reg9 = StoreStackInst $Reg9, $Reg6
// CHKRA-NEXT:  $Reg9 = BranchInst %BB21
...
// CHKRA-NEXT:  $Reg15 = CondBranchInst $Reg15, %BB59, %BB58
// CHKRA-NEXT:%BB29:
...
// CHKRA-NEXT:  $Reg14 = CondBranchInst $Reg14, %BB35, %BB34
// CHKRA-NEXT:%BB33:
// CHKRA-NEXT:  $Reg14 = TryEndInst %BB31, %BB32
// CHKRA-NEXT:%BB34:
// CHKRA-NEXT:  $Reg13 = StoreStackInst $Reg13, $Reg12
// CHKRA-NEXT:  $Reg13 = BranchInst %BB35
// CHKRA-NEXT:%BB35:
// CHKRA-NEXT:  $Reg13 = TryStartInst %BB36, %BB38
// CHKRA-NEXT:%BB36:
// CHKRA-NEXT:  $Reg12 = CatchInst (:any)
// CHKRA-NEXT:  $Reg12 = StoreStackInst $Reg12, $Reg9
// CHKRA-NEXT:  $Reg12 = BranchInst %BB30
...
// CHKRA-NEXT:  $Reg15 = CondBranchInst $Reg15, %BB55, %BB54
// CHKRA-NEXT:%BB38:
...
// CHKRA-NEXT:  $Reg17 = CondBranchInst $Reg17, %BB44, %BB43
// CHKRA-NEXT:%BB42:
// CHKRA-NEXT:  $Reg17 = TryEndInst %BB40, %BB41
// CHKRA-NEXT:%BB43:
// CHKRA-NEXT:  $Reg16 = StoreStackInst $Reg16, $Reg15
// CHKRA-NEXT:  $Reg16 = BranchInst %BB44
// CHKRA-NEXT:%BB44:
// CHKRA-NEXT:  $Reg16 = TryStartInst %BB45, %BB47
// CHKRA-NEXT:%BB45:
// CHKRA-NEXT:  $Reg15 = CatchInst (:any)
// CHKRA-NEXT:  $Reg15 = StoreStackInst $Reg15, $Reg12
// CHKRA-NEXT:  $Reg15 = BranchInst %BB39
...
// CHKRA-NEXT:  $Reg15 = CondBranchInst $Reg15, %BB51, %BB50
// CHKRA-NEXT:%BB47:
...
// CHKRA-NEXT:  $Reg15 = BranchInst %BB51
// CHKRA-NEXT:%BB51:
// CHKRA-NEXT:  $Reg15 = TryEndInst %BB36, %BB37
// CHKRA-NEXT:%BB52:
// CHKRA-NEXT:  $Reg13 = LoadStackInst (:any) $Reg13
...
// CHKRA-NEXT:%BB55:
// CHKRA-NEXT:  $Reg15 = TryEndInst %BB27, %BB28
// CHKRA-NEXT:%BB56:
// CHKRA-NEXT:  $Reg10 = LoadStackInst (:any) $Reg10
...
// CHKRA-NEXT:%BB59:
// CHKRA-NEXT:  $Reg15 = TryEndInst %BB18, %BB19
// CHKRA-NEXT:%BB60:
// CHKRA-NEXT:  $Reg7 = LoadStackInst (:any) $Reg7
...
// CHKRA-NEXT:  $Reg15 = IteratorCloseInst (:any) $Reg15, false: boolean
// CHKRA-NEXT:  $Reg15 = BranchInst %BB63
// CHKRA-NEXT:%BB63:
// CHKRA-NEXT:  $Reg15 = TryEndInst %BB9, %BB10
// CHKRA-NEXT:%BB64:
