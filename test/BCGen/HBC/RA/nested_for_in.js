...
// CHECK-NEXT:                 StorePropertyLooseInst {r3} %20: object, {r2} %4: object, "y": string
...
// CHECK-NEXT:  {r1}     %26 = LoadPropertyInst (:any) {r2} %4: object, "x": string
...
// CHECK-NEXT:%BB3:
// CHECK-NEXT:  {r1}     %33 = LoadPropertyInst (:any) {r2} %4: object, "i": string
// CHECK-NEXT:  {r1}     %34 = UnaryIncInst (:number|bigint) {r1} %33: any
// CHECK-NEXT:                 StorePropertyLooseInst {r1} %34: number|bigint, {r2} %4: object, "i": string
// CHECK-NEXT:  {r1}     %36 = LoadPropertyInst (:any) {r2} %4: object, "i": string
...
// CHECK-NEXT:  {r6}     %41 = LoadPropertyInst (:any) {r2} %4: object, "a": string
