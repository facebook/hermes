...
// CHECK-NEXT:  $Reg1 @5 [empty]	%5 = StorePropertyLooseInst %4 : object, %0 : object, "a" : string
// CHECK-NEXT:  $Reg1 @6 [7...8) 	%6 = AllocObjectInst 0 : number, empty
// CHECK-NEXT:  $Reg1 @7 [empty]	%7 = StorePropertyLooseInst %6 : object, %0 : object, "x" : string
// CHECK-NEXT:  $Reg1 @8 [9...10) 	%8 = AllocObjectInst 0 : number, empty
// CHECK-NEXT:  $Reg1 @9 [empty]	%9 = StorePropertyLooseInst %8 : object, %0 : object, "y" : string
// CHECK-NEXT:  $Reg1 @10 [11...12) 	%10 = HBCLoadConstInst 0 : number
// CHECK-NEXT:  $Reg1 @11 [empty]	%11 = StorePropertyLooseInst %10 : number, %0 : object, "i" : string
...
// CHECK-NEXT:  $Reg1 @16 [empty]	%16 = StorePropertyLooseInst %15 : object, %0 : object, "y" : string
...
// CHECK-NEXT:  $Reg1 @32 [empty]	%30 = StorePropertyLooseInst %29 : number|bigint, %0 : object, "i" : string
...
// CHECK-NEXT:  $Reg10 @28 [empty]	%37 = StorePropertyLooseInst %35, %36, %3 : number
