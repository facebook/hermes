...
// CHECK-NEXT:  {r1}      %2 = CreateFunctionInst (:object) {r1} %0: environment, %VS0: any, %foo(): functionCode
// CHECK-NEXT:  {r2}      %3 = LIRGetGlobalObjectInst (:object)
...
// CHECK-NEXT:  {r2}      %6 = LIRLoadConstInst (:undefined) undefined: undefined
...
// CHECK-NEXT:  {r1}      %6 = LIRLoadConstInst (:undefined) undefined: undefined
