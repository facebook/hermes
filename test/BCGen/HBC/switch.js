...
// CHECK:function f(x) : string
// CHECK-NEXT:frame = []
// CHECK-NEXT:%BB0:
// CHECK-NEXT:  $Reg0 @0 [1...18) 	%0 = HBCLoadConstInst "fall" : string
// CHECK-NEXT:  $Reg1 @1 [2...14) 	%1 = HBCLoadConstInst "" : string
// CHECK-NEXT:  $Reg3 @2 [3...15) 	%2 = LoadParamInst %x
...
// CHECK-NEXT:%BB4:
// CHECK-NEXT:  $Reg1 @17 [18...20) 	%8 = MovInst %0 : string
// CHECK-NEXT:  $Reg0 @18 [empty]	%9 = BranchInst %BB5
// CHECK-NEXT:%BB5:
// CHECK-NEXT:  $Reg1 @19 [2...22) 	%10 = PhiInst %8 : string, %BB4, %17 : string, %BB6
...
// CHECK-NEXT:  $Reg1 @13 [14...20) 	%17 = MovInst %1 : string
// CHECK-NEXT:  $Reg2 @14 [empty]	%18 = CompareBranchInst '===', %16 : number, %2, %BB5, %BB7
// CHECK-NEXT:%BB8:
// CHECK-NEXT:  $Reg2 @10 [11...12) 	%19 = HBCLoadConstInst 3 : number
// CHECK-NEXT:  $Reg2 @11 [empty]	%20 = CompareBranchInst '===', %19 : number, %2, %BB4, %BB6
// CHECK-NEXT:%BB9:
// CHECK-NEXT:  $Reg2 @8 [9...10) 	%21 = HBCLoadConstInst 2 : number
// CHECK-NEXT:  $Reg2 @9 [empty]	%22 = CompareBranchInst '===', %21 : number, %2, %BB3, %BB8
// CHECK-NEXT:%BB10:
// CHECK-NEXT:  $Reg2 @6 [7...8) 	%23 = HBCLoadConstInst 1 : number
// CHECK-NEXT:  $Reg2 @7 [empty]	%24 = CompareBranchInst '===', %23 : number, %2, %BB3, %BB9
// CHECK-NEXT:%BB1:
// CHECK-NEXT:  $Reg2 @4 [5...6) 	%25 = HBCLoadConstInst 0 : number
// CHECK-NEXT:  $Reg2 @5 [empty]	%26 = CompareBranchInst '===', %25 : number, %2, %BB2, %BB10
// CHECK-NEXT:function_end

// CHECK:function regress1(w)
// CHECK-NEXT:frame = []
// CHECK-NEXT:%BB0:
// CHECK-NEXT:  $Reg6 @0 [1...17) 	%0 = HBCLoadConstInst 0 : number
// CHECK-NEXT:  $Reg5 @1 [2...17) 	%1 = HBCLoadConstInst 2 : number
// CHECK-NEXT:  $Reg4 @2 [3...17) 	%2 = HBCGetGlobalObjectInst
// CHECK-NEXT:  $Reg3 @3 [4...17) 	%3 = HBCLoadConstInst undefined : undefined
// CHECK-NEXT:  $Reg2 @4 [5...17) 	%4 = HBCLoadConstInst 1 : number
// CHECK-NEXT:  $Reg1 @5 [6...17) 	%5 = LoadParamInst %w
// CHECK-NEXT:  $Reg0 @6 [7...9) 	%6 = MovInst %0 : number
...
// CHECK-NEXT:  $Reg7 @14 [empty]	%15 = CompareBranchInst '===', %0 : number, %5, %BB2, %BB1
// CHECK-NEXT:%BB4:
// CHECK-NEXT:  $Reg7 @12 [empty]	%16 = CompareBranchInst '===', %4 : number, %5, %BB2, %BB3
// CHECK-NEXT:function_end

// CHECK:function jump_table(x) : undefined|string
// CHECK-NEXT:frame = []
// CHECK-NEXT:%BB0:
// CHECK-NEXT:  $Reg0 @0 [1...2) 	%0 = LoadParamInst %x
...
// CHECK:function string_switch(x) : undefined|number
// CHECK-NEXT:frame = []
// CHECK-NEXT:%BB0:
// CHECK-NEXT:  $Reg1 @0 [1...8) 	%0 = LoadParamInst %x
