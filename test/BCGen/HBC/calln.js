...
// LRA-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %foo1(): undefined, $Reg0
// LRA-NEXT:  $Reg1 = HBCGetGlobalObjectInst (:object)
// LRA-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "foo1": string
// LRA-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %foo2(): undefined, $Reg0
// LRA-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "foo2": string
// LRA-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %foo3(): undefined, $Reg0
// LRA-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "foo3": string
// LRA-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %foo4(): undefined, $Reg0
// LRA-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "foo4": string
// LRA-NEXT:  $Reg0 = HBCCreateFunctionInst (:object) %foo5(): undefined, $Reg0
