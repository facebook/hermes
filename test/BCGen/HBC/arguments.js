...
// CHECK-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %count(): any, $Reg0
// CHECK-NEXT:  $Reg1 = HBCGetGlobalObjectInst (:object)
// CHECK-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "count": string
// CHECK-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %select(): any, $Reg0
// CHECK-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "select": string
// CHECK-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %build(): object, $Reg0
// CHECK-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "build": string
// CHECK-NEXT:  $Reg2 = HBCCreateFunctionInst (:object) %buffalobuffalo(): string|number|bigint, $Reg0
// CHECK-NEXT:  $Reg2 = StorePropertyLooseInst $Reg2, $Reg1, "buffalobuffalo": string
// CHECK-NEXT:  $Reg0 = HBCCreateFunctionInst (:object) %check_phi_handling(): object, $Reg0
