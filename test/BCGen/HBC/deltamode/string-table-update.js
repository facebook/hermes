...
//CHECK-NEXT:  i19[ASCII, {{[0-9]+}}..{{[0-9]+}}] #{{[0-9A-Z]+}}: unicode
//CHECK-NEXT:  i20[ASCII, {{[0-9]+}}..{{[0-9]+}}] #{{[0-9A-Z]+}}: unicode2
//CHECK-NEXT:  i21[ASCII, {{[0-9]+}}..{{[0-9]+}}] #{{[0-9A-Z]+}}: ascii
//CHECK-NEXT:  i22[ASCII, {{[0-9]+}}..{{[0-9]+}}] #{{[0-9A-Z]+}}: key11
