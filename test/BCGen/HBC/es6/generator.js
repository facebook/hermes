...
// CHECK:Function<?anon_0_loop>(2 params, 13 registers, 2 symbols):
...
// CHECK-NEXT:    ResumeGenerator   r6, r5
// CHECK-NEXT:    Mov               r7, r5
// CHECK-NEXT:    JmpTrue           L1, r7
// CHECK-NEXT:    StoreNPToEnvironment r0, 0, r1
...
// CHECK-NEXT:    JmpFalse          L2, r5
// CHECK-NEXT:L5:
// CHECK-NEXT:    LoadFromEnvironment r5, r0, 1
// CHECK-NEXT:    LoadFromEnvironment r7, r0, 0
// CHECK-NEXT:    ToNumeric         r8, r7
// CHECK-NEXT:    Inc               r9, r8
// CHECK-NEXT:    StoreToEnvironment r0, 0, r9
// CHECK-NEXT:    GetByVal          r10, r5, r8
// CHECK-NEXT:    SaveGenerator     L3
// CHECK-NEXT:    Ret               r10
// CHECK-NEXT:L3:
// CHECK-NEXT:    ResumeGenerator   r5, r11
// CHECK-NEXT:    Mov               r7, r11
// CHECK-NEXT:    JmpTrue           L4, r7
// CHECK-NEXT:    TryGetById        r7, r4, 1, "y"
