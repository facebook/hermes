...
INCS+=" -I $INC_PATH/hermes/facebook/llvm/src/include"
INCS+=" -I $INC_PATH/hermes/facebook/llvm/gen-osx-host/include"
...
LIBS+=" $LIB_PATH/hermes/facebook/llvm/support-c#macosx-x86_64,static/libsupport-c.a"
LIBS+=" $LIB_PATH/hermes/facebook/llvm/LLVMSupport#macosx-x86_64,static/libLLVMSupport.a"
