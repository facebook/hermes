...
// CHECK-NEXT:  {loc0}    %3 = CreateFunctionInst (:object) {loc0} %2: environment, %VS0: any, %foo(): functionCode
// CHECK-NEXT:                 StorePropertyLooseInst {loc0} %3: object, {loc1} %1: object, "foo": string
