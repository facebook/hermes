...
// CHKIR-NEXT:frame = []
// CHKIR-NEXT:%BB0:
// CHKIR-NEXT:  %0 = DeclareGlobalVarInst "foo": string
// CHKIR-NEXT:  %1 = CreateFunctionInst (:object) %foo(): any
// CHKIR-NEXT:  %2 = StorePropertyLooseInst %1: object, globalObject: object, "foo": string
// CHKIR-NEXT:  %3 = ReturnInst undefined: undefined
...
// CHKIR-NEXT:  %1 = SwitchInst %0: any, %BB1, 0: number, %BB2, 1: number, %BB1
// CHKIR-NEXT:%BB1:
// CHKIR-NEXT:  %2 = PhiInst (:any) 2: number, %BB2, %0: any, %BB0
// CHKIR-NEXT:  %3 = ReturnInst %2: any
// CHKIR-NEXT:%BB2:
// CHKIR-NEXT:  %4 = BranchInst %BB1
// CHKIR-NEXT:function_end

// CHKLIR:function global(): undefined
// CHKLIR-NEXT:frame = []
// CHKLIR-NEXT:%BB0:
// CHKLIR-NEXT:  %0 = DeclareGlobalVarInst "foo": string
...
// CHKLIR-NEXT:  %4 = StorePropertyLooseInst %2: object, %3: object, "foo": string
// CHKLIR-NEXT:  %5 = HBCLoadConstInst (:undefined) undefined: undefined
// CHKLIR-NEXT:  %6 = ReturnInst %5: undefined
...
// CHKLIR-NEXT:  %2 = BranchInst %BB1
// CHKLIR-NEXT:%BB2:
// CHKLIR-NEXT:  %3 = PhiInst (:any) %0: number, %BB3, %1: any, %BB4
// CHKLIR-NEXT:  %4 = ReturnInst %3: any
// CHKLIR-NEXT:%BB3:
// CHKLIR-NEXT:  %5 = BranchInst %BB2
// CHKLIR-NEXT:%BB4:
// CHKLIR-NEXT:  %6 = HBCLoadConstInst (:number) 1: number
// CHKLIR-NEXT:  %7 = CmpBrStrictlyEqualInst %6: number, %1: any, %BB2, %BB2
// CHKLIR-NEXT:%BB1:
// CHKLIR-NEXT:  %8 = HBCLoadConstInst (:number) 0: number
// CHKLIR-NEXT:  %9 = CmpBrStrictlyEqualInst %8: number, %1: any, %BB3, %BB4
// CHKLIR-NEXT:function_end
