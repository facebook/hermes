...
impl Visitor for Analyzer {
    ...
    fn visit_class_declaration(&mut self, ast: &hermes_estree::ClassDeclaration) {
    ...
    fn visit_class_expression(&mut self, ast: &hermes_estree::ClassExpression) {
        self.enter(ScopeKind::Class, |visitor| {
            if let Some(id) = &ast.class.id {
    ...
    fn visit_class_property(&mut self, ast: &hermes_estree::ClassProperty) {
    ...
    fn visit_class_private_property(&mut self, ast: &hermes_estree::ClassPrivateProperty) {
        // Static (non-computed) property names do not introduce a new identifier
        // into any scope
        match &ast.key {
    ...
    fn visit_static_block(&mut self, ast: &hermes_estree::StaticBlock) {
    ...
    fn visit_method_definition(&mut self, ast: &hermes_estree::MethodDefinition) {
    ...
    fn visit_function_declaration(&mut self, ast: &hermes_estree::FunctionDeclaration) {
    ...
    fn visit_function_expression(&mut self, ast: &hermes_estree::FunctionExpression) {
        self.enter(ScopeKind::Function, |visitor| {
            if let Some(id) = &ast.function.id {
                let declaration = visitor.manager.add_declaration(
                    visitor.current,
    ...
    fn visit_arrow_function_expression(&mut self, ast: &hermes_estree::ArrowFunctionExpression) {
        self.enter(ScopeKind::Function, |visitor| {
            Analyzer::visit_function(visitor, ast);
        });
    }

    fn visit_assignment_expression(&mut self, ast: &hermes_estree::AssignmentExpression) {
    ...
    fn visit_block_statement(&mut self, ast: &hermes_estree::BlockStatement) {
    ...
    fn visit_break_statement(&mut self, ast: &hermes_estree::BreakStatement) {
    ...
    fn visit_catch_clause(&mut self, ast: &hermes_estree::CatchClause) {
    ...
    fn visit_continue_statement(&mut self, ast: &hermes_estree::ContinueStatement) {
        let range = ast
            .label
            .as_ref()
    ...
    fn visit_for_in_statement(&mut self, ast: &hermes_estree::ForInStatement) {
    ...
    fn visit_for_of_statement(&mut self, ast: &hermes_estree::ForOfStatement) {
        Analyzer::visit_for_in_of(
            self,
            AstNode::from(ast),
            &ast.left,
    ...
    fn visit_for_statement(&mut self, ast: &hermes_estree::ForStatement) {
        let mut for_scope: Option<ScopeId> = None;
    ...
    fn visit_identifier(&mut self, ast: &hermes_estree::Identifier) {
    ...
    fn visit_labeled_statement(&mut self, ast: &hermes_estree::LabeledStatement) {
        let body = &ast.body;
        let kind = match body {
    ...
    fn visit_member_expression(&mut self, ast: &hermes_estree::MemberExpression) {
    ...
    fn visit_meta_property(&mut self, _ast: &hermes_estree::MetaProperty) {
        // no-op, these are all builtins
    }

    fn visit_private_identifier(&mut self, _ast: &hermes_estree::PrivateIdentifier) {
        // no-op, these refere to class properties
    }

    fn visit_private_name(&mut self, _ast: &hermes_estree::PrivateName) {
        // no-op, these refere to class properties
    }
    ...
    fn visit_property(&mut self, ast: &hermes_estree::Property) {
        if ast.is_computed {
            self.visit_expression(&ast.key);
        }
    ...
    fn visit_switch_statement(&mut self, ast: &hermes_estree::SwitchStatement) {
    ...
    fn visit_variable_declaration(&mut self, ast: &hermes_estree::VariableDeclaration) {
        let kind = ast.kind;
    ...
    fn visit_jsxattribute(&mut self, ast: &hermes_estree::JSXAttribute) {
    ...
    fn visit_jsxclosing_element(&mut self, _ast: &hermes_estree::JSXClosingElement) {
        // no-op, should not be counted as a reference
    }

    fn visit_jsxidentifier(&mut self, ast: &hermes_estree::JSXIdentifier) {
        Analyzer::visit_reference_identifier(
            self,
            &ast.name,
            AstNode::from(ast),
    ...
    fn visit_jsxfragment(&mut self, ast: &hermes_estree::JSXFragment) {
    ...
    fn visit_jsxmember_expression(&mut self, ast: &hermes_estree::JSXMemberExpression) {
    ...
    fn visit_jsxnamespaced_name(&mut self, ast: &hermes_estree::JSXNamespacedName) {
        // NOTE: ignore the 'name' since it doesn't refer to a variable
        self.visit_jsxidentifier(&ast.namespace);
    }

    fn visit_jsxopening_element(&mut self, ast: &hermes_estree::JSXOpeningElement) {
