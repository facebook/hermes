...
#include "llvh/ADT/PointerIntPair.h"
...
public:
  ...
  template <typename T> int is() const {
    using Ty = typename ::llvh::PointerUnionTypeSelector<
        PT1, T, IsPT1,
        ::llvh::PointerUnionTypeSelector<PT2, T, IsPT2,
...
public:
  ...
  template <typename T> int is() const {
    ...
    using Ty = typename ::llvh::PointerUnionTypeSelector<
        PT1, T, IsInnerUnion,
        ::llvh::PointerUnionTypeSelector<PT2, T, IsInnerUnion, IsPT3>>::Return;
...
public:
  ...
  template <typename T> int is() const {
    ...
    using Ty = typename ::llvh::PointerUnionTypeSelector<
        PT1, T, InnerUnion1,
        ::llvh::PointerUnionTypeSelector<PT2, T, InnerUnion1,
                                         InnerUnion2>>::Return;
